...
public class ComboReloadsProcessHelper extends CalloutHelper {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
   String strProcessId = vars.getStringParameter("inpadProcessId");
     ...
     if (strProcessId.equals("CE1A567B76834CC18B87B9849C4EC8FF")) {
       processCE1A567B76834CC18B87B9849C4EC8FF(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("683D8B2A24EF412C96E4DBEF34F1BD01")) {
       process683D8B2A24EF412C96E4DBEF34F1BD01(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("101E10B4677243799D7EF6AFDE185A7D")) {
       process101E10B4677243799D7EF6AFDE185A7D(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("4B0CEC0B3AFE49CC893E73D7D6CC1B91")) {
       process4B0CEC0B3AFE49CC893E73D7D6CC1B91(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("8D397291161B4278BF176601BD6C8AB0")) {
       process8D397291161B4278BF176601BD6C8AB0(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("D14396E80E28430BB958039C9E7CA381")) {
       processD14396E80E28430BB958039C9E7CA381(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("E54AB04AA5844DAE955537B41633F655")) {
       processE54AB04AA5844DAE955537B41633F655(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("8B8D9F05FCFD429380C68248BD045CEB")) {
       process8B8D9F05FCFD429380C68248BD045CEB(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("8F77212363EC46BD898B9451D450879A")) {
       process8F77212363EC46BD898B9451D450879A(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("CC39852BA9A2403586BAB26B11C8A5AE")) {
       processCC39852BA9A2403586BAB26B11C8A5AE(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("852A3638379F4A99AF086D293A0A6D6A")) {
       process852A3638379F4A99AF086D293A0A6D6A(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("D1E3CC3D6D884402B04FFDD2C55FCE6E")) {
       processD1E3CC3D6D884402B04FFDD2C55FCE6E(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("9D695C033D554981AEE5C345932905A1")) {
       process9D695C033D554981AEE5C345932905A1(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("8096BB8256F047E082CF105C6F8F4F49")) {
       process8096BB8256F047E082CF105C6F8F4F49(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("61E0B54EB8F74C92A3A93D524DF41338")) {
       process61E0B54EB8F74C92A3A93D524DF41338(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("B7C897C397F14600B2202D37963B80DA")) {
       processB7C897C397F14600B2202D37963B80DA(response, vars, strTabId, windowId);
       return;
     }
    ...
    private void processCE1A567B76834CC18B87B9849C4EC8FF(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsCE1A567B76834CC18B87B9849C4EC8FF';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process683D8B2A24EF412C96E4DBEF34F1BD01(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads683D8B2A24EF412C96E4DBEF34F1BD01';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process101E10B4677243799D7EF6AFDE185A7D(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads101E10B4677243799D7EF6AFDE185A7D';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process4B0CEC0B3AFE49CC893E73D7D6CC1B91(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads4B0CEC0B3AFE49CC893E73D7D6CC1B91';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process8D397291161B4278BF176601BD6C8AB0(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads8D397291161B4278BF176601BD6C8AB0';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void processD14396E80E28430BB958039C9E7CA381(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsD14396E80E28430BB958039C9E7CA381';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void processE54AB04AA5844DAE955537B41633F655(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsE54AB04AA5844DAE955537B41633F655';\n\n");
        resultado.append("var respuesta = new Array(\n");
      ...
      if (CalloutHelper.commandInCommandList(command, "inpcOrderId")) {
        if (!isFirst) resultado.append(", \n");
        comboTableData = new ComboTableData(vars, this, "19", "M_Product_ID", "", "98F3F6DB107E45619D30767103396DC6", Utility.getReferenceableOrg(vars, vars.getStringParameter("inpadOrgId")), Utility.getContext(this, vars, "#User_Client", windowId), 0);
        comboTableData.fillParameters(null, windowId, "");
    ...
    private void process8B8D9F05FCFD429380C68248BD045CEB(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads8B8D9F05FCFD429380C68248BD045CEB';\n\n");
        resultado.append("var respuesta = new Array(\n");
      ...
      if (CalloutHelper.commandInCommandList(command, "inpcProjectId")) {
        if (!isFirst) resultado.append(", \n");
        comboTableData = new ComboTableData(vars, this, "19", "M_Requisition_ID", "", "58DA8089A516442AA0F9B0BD245305C5", Utility.getReferenceableOrg(vars, vars.getStringParameter("inpadOrgId")), Utility.getContext(this, vars, "#User_Client", windowId), 0);
        comboTableData.fillParameters(null, windowId, "");
        resultField = "inpmRequisitionId";
    ...
    private void process8F77212363EC46BD898B9451D450879A(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads8F77212363EC46BD898B9451D450879A';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void processCC39852BA9A2403586BAB26B11C8A5AE(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsCC39852BA9A2403586BAB26B11C8A5AE';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process852A3638379F4A99AF086D293A0A6D6A(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads852A3638379F4A99AF086D293A0A6D6A';\n\n");
        resultado.append("var respuesta = new Array(\n");
      ...
      if (CalloutHelper.commandInCommandList(command, "inpcOrderId")) {
        if (!isFirst) resultado.append(", \n");
        comboTableData = new ComboTableData(vars, this, "19", "Dtpo_Pocopfile_ID", "", "C683F599556B40DE9C0B95CF3E49DDED", Utility.getReferenceableOrg(vars, vars.getStringParameter("inpadOrgId")), Utility.getContext(this, vars, "#User_Client", windowId), 0);
        comboTableData.fillParameters(null, windowId, "");
        resultField = "inpdtpoPocopfileId";
    ...
    private void processD1E3CC3D6D884402B04FFDD2C55FCE6E(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsD1E3CC3D6D884402B04FFDD2C55FCE6E';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process9D695C033D554981AEE5C345932905A1(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads9D695C033D554981AEE5C345932905A1';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process8096BB8256F047E082CF105C6F8F4F49(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads8096BB8256F047E082CF105C6F8F4F49';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process61E0B54EB8F74C92A3A93D524DF41338(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads61E0B54EB8F74C92A3A93D524DF41338';\n\n");
        resultado.append("var respuesta = new Array(\n");
      ...
      if (CalloutHelper.commandInCommandList(command, "inpmProductId")) {
        if (!isFirst) resultado.append(", \n");
        comboTableData = new ComboTableData(vars, this, "19", "Dtpo_Pocop_ID", "", "BD84936EB158429CB587331D42BFCC5F", Utility.getReferenceableOrg(vars, vars.getStringParameter("inpadOrgId")), Utility.getContext(this, vars, "#User_Client", windowId), 0);
        comboTableData.fillParameters(null, windowId, "");
        resultField = "inpdtpoPocopId";
    ...
    private void processB7C897C397F14600B2202D37963B80DA(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsB7C897C397F14600B2202D37963B80DA';\n\n");
        resultado.append("var respuesta = new Array(\n");
