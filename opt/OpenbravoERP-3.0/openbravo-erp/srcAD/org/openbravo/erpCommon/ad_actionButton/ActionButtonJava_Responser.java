  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      printPageDefault(response, vars, strProcessId);
        ...
        printPageButton8E4F47F66A4241E08C5F169D0AC3F20F(response, vars, strProcessId);
    } else if (vars.commandIn("BUTTONC55E968E76974358AEB1160CF39EDC03")) {
        
        printPageButtonC55E968E76974358AEB1160CF39EDC03(response, vars, strProcessId);
    } else if (vars.commandIn("BUTTONFFFB3A6A2D2E40AFAC4F0D23DA36B026")) {
        
        printPageButtonFFFB3A6A2D2E40AFAC4F0D23DA36B026(response, vars, strProcessId);
    ...
    } else if (vars.commandIn("SAVE_BUTTONActionButton8E4F47F66A4241E08C5F169D0AC3F20F")) {
        process8E4F47F66A4241E08C5F169D0AC3F20F(strProcessId, vars, request, response);
    } else if (vars.commandIn("SAVE_BUTTONActionButtonC55E968E76974358AEB1160CF39EDC03")) {
        processC55E968E76974358AEB1160CF39EDC03(strProcessId, vars, request, response);
    } else if (vars.commandIn("SAVE_BUTTONActionButtonFFFB3A6A2D2E40AFAC4F0D23DA36B026")) {
        processFFFB3A6A2D2E40AFAC4F0D23DA36B026(strProcessId, vars, request, response);
...
comboTableData = null;
    ...
    void printPageButton8E4F47F66A4241E08C5F169D0AC3F20F(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 8E4F47F66A4241E08C5F169D0AC3F20F");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/ActionButton8E4F47F66A4241E08C5F169D0AC3F20F", discard).createXmlDocument();
      xmlDocument.setParameter("processing", "Y");
      xmlDocument.setParameter("form", "ActionButtonJava_Responser.html");
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
    ...
    void printPageButtonC55E968E76974358AEB1160CF39EDC03(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      log4j.debug("Output: Button process C55E968E76974358AEB1160CF39EDC03");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/ActionButtonC55E968E76974358AEB1160CF39EDC03", discard).createXmlDocument();
      xmlDocument.setParameter("processing", "Y");
      xmlDocument.setParameter("form", "ActionButtonJava_Responser.html");
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
    ...
    void printPageButtonFFFB3A6A2D2E40AFAC4F0D23DA36B026(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      log4j.debug("Output: Button process FFFB3A6A2D2E40AFAC4F0D23DA36B026");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/ActionButtonFFFB3A6A2D2E40AFAC4F0D23DA36B026", discard).createXmlDocument();
      xmlDocument.setParameter("processing", "Y");
      xmlDocument.setParameter("form", "ActionButtonJava_Responser.html");
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      ...
      {
        OBError myMessage = vars.getMessage("FFFB3A6A2D2E40AFAC4F0D23DA36B026");
        vars.removeMessage("FFFB3A6A2D2E40AFAC4F0D23DA36B026");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
...
params.put("action", straction);
    ...
    private void process8E4F47F66A4241E08C5F169D0AC3F20F(String strProcessId, VariablesSecureApp vars, HttpServletRequest request, HttpServletResponse response) throws IOException,
      ServletException {
        ...
        OBError myMessage = null;
        try {
          new org.datatreis.pocustomize.erpCommon.ad_actionButton.AmmendmentOrder().execute(pb);
          myMessage = (OBError) pb.getResult();
          myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
          myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
        } catch (Exception ex) {
    ...
    private void processC55E968E76974358AEB1160CF39EDC03(String strProcessId, VariablesSecureApp vars, HttpServletRequest request, HttpServletResponse response) throws IOException,
      ServletException {
        ...
        OBError myMessage = null;
        try {
          new org.datatreis.pocustomize.erpCommon.ad_actionButton.CreateCOP().execute(pb);
          myMessage = (OBError) pb.getResult();
          myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
          myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
        } catch (Exception ex) {
    ...
    private void processFFFB3A6A2D2E40AFAC4F0D23DA36B026(String strProcessId, VariablesSecureApp vars, HttpServletRequest request, HttpServletResponse response) throws IOException,
      ServletException {
        ...
        OBError myMessage = null;
        try {
          new org.datatreis.pocustomize.erpCommon.ad_actionButton.SynchroniseJavaProcess().execute(pb);
          myMessage = (OBError) pb.getResult();
          myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
          myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
        } catch (Exception ex) {
