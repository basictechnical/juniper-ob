...
vars.getGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_Requisition_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|M_PriceList_ID", data[0].mPricelistId);    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].cCurrencyId);    vars.setSessionValue(windowId + "|EM_DT_Project_ID", data[0].emDtProjectId);    vars.setSessionValue(windowId + "|M_Requisition_ID", data[0].mRequisitionId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);
