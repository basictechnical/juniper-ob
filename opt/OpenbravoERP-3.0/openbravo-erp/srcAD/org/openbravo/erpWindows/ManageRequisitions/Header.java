...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Createpo", "N", "1004400000", "N", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "1004400000", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "1004400000", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "1004400000", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "1004400000", "N", dataField))), Utility.getDefault(this, vars, "Processed", "N", "1004400000", "N", dataField), Utility.getDefault(this, vars, "AD_User_ID", "@#AD_User_ID@", "1004400000", "", dataField), Utility.getDefault(this, vars, "Processing", "N", "1004400000", "N", dataField), Utility.getDefault(this, vars, "EM_Epb_Mainsection_ID", "", "1004400000", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "1004400000", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "1004400000", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "1004400000", "", dataField), HeaderData.selectDef803534_0(this, Utility.getDefault(this, vars, "Createdby", "", "1004400000", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "1004400000", "", dataField), HeaderData.selectDef803536_1(this, Utility.getDefault(this, vars, "Updatedby", "", "1004400000", "", dataField)), Utility.getDefault(this, vars, "Description", "", "1004400000", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "1004400000", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "1004400000", "", dataField), HeaderData.selectDef803539_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "1004400000", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_ID", "", "1004400000", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "1004400000", "", dataField), Utility.getDefault(this, vars, "EM_DT_Project_ID", "", "1004400000", "", dataField), HeaderData.selectDef982395F7004F4104A9469C94E6AF4D66_3(this, Utility.getDefault(this, vars, "EM_DT_Project_ID", "", "1004400000", "", dataField)), Utility.getDefault(this, vars, "EM_Dt_Service", "N", "1004400000", "N", dataField), Utility.getDefault(this, vars, "EM_Epb_Subtasks_ID", "", "1004400000", "", dataField), Utility.getDefault(this, vars, "EM_Epb_Subsection_ID", "", "1004400000", "", dataField), Utility.getDefault(this, vars, "EM_Dt_Work", "N", "1004400000", "N", dataField));
