  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("5C685C48B91D40E59B284D4CFAE869C7")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("5C685C48B91D40E59B284D4CFAE869C7");
        SessionInfo.setModuleId("96352E490BC64F04B103F8EC1916A4C4");
        if (securedProcess || explicitAccess.contains("5C685C48B91D40E59B284D4CFAE869C7")) {
          classInfo.type = "P";
          classInfo.id = "5C685C48B91D40E59B284D4CFAE869C7";
        }
      }
...
vars.getRequestGlobalVariable("inpParamC_BPartner_ID", tabId + "|paramC_BPartner_ID");
      ...
      response.sendRedirect(strDireccion + request.getServletPath());
     ...
     } else if (vars.commandIn("BUTTONEM_Dtzk_Associatecostbudget5C685C48B91D40E59B284D4CFAE869C7")) {
        vars.setSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.stremDtzkAssociatecostbudget", vars.getStringParameter("inpemDtzkAssociatecostbudget"));
        vars.setSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.strClient", vars.getStringParameter("inpadClientId"));
        ...
        vars.setSessionObject("button5C685C48B91D40E59B284D4CFAE869C7.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "5C685C48B91D40E59B284D4CFAE869C7", request.getServletPath());    
     } else if (vars.commandIn("BUTTON5C685C48B91D40E59B284D4CFAE869C7")) {
        String strC_Project_ID = vars.getGlobalVariable("inpcProjectId", windowId + "|C_Project_ID", "");
        String stremDtzkAssociatecostbudget = vars.getSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.stremDtzkAssociatecostbudget");
        String strProcessing = vars.getSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.strProcessing");
        String strOrg = vars.getSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.strOrg");
        String strClient = vars.getSessionValue("button5C685C48B91D40E59B284D4CFAE869C7.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Dtzk_Associatecostbudget5C685C48B91D40E59B284D4CFAE869C7(response, vars, strC_Project_ID, stremDtzkAssociatecostbudget, strProcessing);
        }


    } else if (vars.commandIn("SAVE_BUTTONEM_Dtzk_Associatecostbudget5C685C48B91D40E59B284D4CFAE869C7")) {
        String strC_Project_ID = vars.getGlobalVariable("inpKey", windowId + "|C_Project_ID", "");
        @SuppressWarnings("unused")
        String stremDtzkAssociatecostbudget = vars.getStringParameter("inpemDtzkAssociatecostbudget");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "5C685C48B91D40E59B284D4CFAE869C7", (("C_Project_ID".equalsIgnoreCase("AD_Language"))?"0":strC_Project_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
comboTableData = null;
xmlDocument.setParameter("EM_Dtzk_Associatecostbudget_BTNname", Utility.getButtonName(this, vars, "9520AECAA52C4026AA6C7C89316786BB", "EM_Dtzk_Associatecostbudget_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Dtzk_Associatecostbudget = org.openbravo.erpCommon.utility.Utility.isModalProcess("5C685C48B91D40E59B284D4CFAE869C7"); 
xmlDocument.setParameter("EM_Dtzk_Associatecostbudget_Modal", modalEM_Dtzk_Associatecostbudget?"true":"false");
...
xmlDocument.setParameter("buttonPlannedQty", Utility.messageBD(this, "Calc", vars.getLanguage()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonEM_Dtzk_Associatecostbudget5C685C48B91D40E59B284D4CFAE869C7(HttpServletResponse response, VariablesSecureApp vars, String strC_Project_ID, String stremDtzkAssociatecostbudget, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 5C685C48B91D40E59B284D4CFAE869C7");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Dtzk_Associatecostbudget5C685C48B91D40E59B284D4CFAE869C7", discard).createXmlDocument();
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "5C685C48B91D40E59B284D4CFAE869C7");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("5C685C48B91D40E59B284D4CFAE869C7");
        vars.removeMessage("5C685C48B91D40E59B284D4CFAE869C7");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
