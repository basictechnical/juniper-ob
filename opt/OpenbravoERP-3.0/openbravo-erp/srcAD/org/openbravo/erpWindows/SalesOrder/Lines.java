...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    vars.setSessionValue(windowId + "|HASSECONDUOM", strHASSECONDUOM);
        String strATTRIBUTESET = LinesData.selectAux0A17DEEA6AE34D0AAF8D7D789BBEB16A(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].mProductId)));
    ...
    vars.setSessionValue(windowId + "|Processed", strProcessed);
        String strATTRSETVALUETYPE = LinesData.selectAux4B4FADE3E6AC41F0827B3120AD6C3FAA(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].mProductId)));
    vars.setSessionValue(windowId + "|ATTRSETVALUETYPE", strATTRSETVALUETYPE);
        String strUsesAlternate = LinesData.selectAux81E735D7FA45476498395FDD9AB982ED(this, ((dataField!=null)?dataField.getField("cTaxId"):((data==null || data.length==0)?"":data[0].cTaxId)));
    vars.setSessionValue(windowId + "|UsesAlternate", strUsesAlternate);
        String strisBOM = LinesData.selectAuxBBFAC7EEB599451388E60BA877C89809(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].mProductId)));
    vars.setSessionValue(windowId + "|isBOM", strisBOM);
        String strIsStocked = LinesData.selectAuxCF00CC6BA5F747CBB77CA682833A22FE(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].mProductId)));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Order_ID, Utility.getDefault(this, vars, "Line_Gross_Amount", "0", "143", "", dataField), Utility.getDefault(this, vars, "CANCELPRICEAD", "N", "143", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "143", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "143", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "143", "", dataField), LinesData.selectDef2210_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "143", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "143", "", dataField), LinesData.selectDef2212_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "143", "", dataField)), LinesData.selectDef2214(this, strPC_Order_ID), Utility.getDefault(this, vars, "DateOrdered", "@DateOrdered@", "143", "", dataField), Utility.getDefault(this, vars, "DatePromised", "@DatePromised@", "143", "", dataField), Utility.getDefault(this, vars, "DateDelivered", "", "143", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "", "143", "", dataField), Utility.getDefault(this, vars, "Description", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "143", "", dataField), LinesData.selectDef2221_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "@M_Warehouse_ID@", "143", "", dataField), Utility.getDefault(this, vars, "QtyOrdered", "1", "143", "0", dataField), Utility.getDefault(this, vars, "QtyReserved", "", "143", "0", dataField), Utility.getDefault(this, vars, "QtyDelivered", "", "143", "0", dataField), Utility.getDefault(this, vars, "QtyInvoiced", "", "143", "0", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "@M_Shipper_ID@", "143", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "143", "", dataField), Utility.getDefault(this, vars, "PriceList", "", "143", "0", dataField), Utility.getDefault(this, vars, "PriceActual", "", "143", "0", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "143", "", dataField), LinesData.selectDef2764(this, strPC_Order_ID), Utility.getDefault(this, vars, "DirectShip", "", "143", "N", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "143", "0", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "143", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "@C_BPartner_Location_ID@", "143", "", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "143", "0", dataField), Utility.getDefault(this, vars, "PriceLimit", "", "143", "0", dataField), Utility.getDefault(this, vars, "Discount", "0", "143", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Return_Reason_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Order_Discount_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Ref_OrderLine_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Iseditlinenetamt", "N", "143", "N", dataField), Utility.getDefault(this, vars, "Taxbaseamt", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "143", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "143", "0", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "143", "", dataField), LinesData.selectDef8767_3(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "User1_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "143", "N", dataField), Utility.getDefault(this, vars, "BOM_Parent_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "grosspricestd", "0", "143", "0", dataField), Utility.getDefault(this, vars, "Explode", "", "143", "N", dataField), Utility.getDefault(this, vars, "M_Inoutline_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "143", "", dataField), LinesData.selectDefB2023461A08649D58E5D144D4FC2C507_4(this, Utility.getDefault(this, vars, "C_Project_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "GrossPriceList", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_Rule_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Create_Reservation", "", "143", "", dataField), Utility.getDefault(this, vars, "SO_Res_Status", "", "143", "", dataField), Utility.getDefault(this, vars, "Manage_Reservation", "", "143", "N", dataField), Utility.getDefault(this, vars, "Manage_Prereservation", "", "143", "N", dataField), Utility.getDefault(this, vars, "Quotationline_ID", "", "143", "", dataField), LinesData.selectDefE9612846B6F5472A8F64CF729E0B25AE_5(this, Utility.getDefault(this, vars, "Quotationline_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "Gross_Unit_Price", "0", "143", "", dataField));
