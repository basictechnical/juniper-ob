...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderId") == null || dataField.getField("cOrderId").equals("")) {
        ...
        String strORDERTYPE = HeaderData.selectAux6(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].cOrderId)));
    vars.setSessionValue(windowId + "|ORDERTYPE", strORDERTYPE);
        String strDOCBASETYPE = HeaderData.selectAux09BF7886BE7846C3B870F354B8301159(this, ((dataField!=null)?dataField.getField("cDoctypetargetId"):((data==null || data.length==0)?"":data[0].cDoctypetargetId)));
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strPromotionsDefined = HeaderData.selectAuxD0DC4F3EC11B4F6D9457EF08B5AF54C5(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].adClientId)));
