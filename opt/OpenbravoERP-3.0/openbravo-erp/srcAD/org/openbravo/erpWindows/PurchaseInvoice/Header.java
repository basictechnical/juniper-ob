...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    vars.setSessionValue(windowId + "|VoidAutomaticallyCreated", strVoidAutomaticallyCreated);
        String strshowAddPayment = HeaderData.selectAux9E5EF28335254D948E30BAF9BF41B3A7(this, ((dataField!=null)?dataField.getField("cInvoiceId"):((data==null || data.length==0)?"":data[0].cInvoiceId)));
...
xmlDocument.setParameter("EM_APRM_Addpayment_BTNname", Utility.getButtonName(this, vars, "80D2CCB125DAECE6E040007F01000DDE", "EM_APRM_Addpayment_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_Addpayment = org.openbravo.erpCommon.utility.Utility.isModalProcess("2EED9BC16DB34D2B80BA40A21564BECF"); 
