  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("8E4F47F66A4241E08C5F169D0AC3F20F")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("8E4F47F66A4241E08C5F169D0AC3F20F");
      ...
      if (command.contains("3E9EEB205AAA4ABF904D2157F1AD6896")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("3E9EEB205AAA4ABF904D2157F1AD6896");
        SessionInfo.setModuleId("7B984714AD4D42B6B410D20BEFDB154F");
        if (securedProcess || explicitAccess.contains("3E9EEB205AAA4ABF904D2157F1AD6896")) {
          classInfo.type = "P";
          classInfo.id = "3E9EEB205AAA4ABF904D2157F1AD6896";
        }
      }
      ...
      if (explicitAccess.contains("8E4F47F66A4241E08C5F169D0AC3F20F") || (securedProcess && command.contains("8E4F47F66A4241E08C5F169D0AC3F20F"))) {
        classInfo.type = "P";
        classInfo.id = "8E4F47F66A4241E08C5F169D0AC3F20F";
      }
...
String stradTableId = "259";
     ...
     } else if (vars.commandIn("BUTTONEM_Dtpo_Synpoamt3E9EEB205AAA4ABF904D2157F1AD6896")) {
        vars.setSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.stremDtpoSynpoamt", vars.getStringParameter("inpemDtpoSynpoamt"));
        vars.setSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button3E9EEB205AAA4ABF904D2157F1AD6896.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "3E9EEB205AAA4ABF904D2157F1AD6896", request.getServletPath());    
     } else if (vars.commandIn("BUTTON3E9EEB205AAA4ABF904D2157F1AD6896")) {
        String strC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID", "");
        String stremDtpoSynpoamt = vars.getSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.stremDtpoSynpoamt");
        String strProcessing = vars.getSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.strProcessing");
        String strOrg = vars.getSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.strOrg");
        String strClient = vars.getSessionValue("button3E9EEB205AAA4ABF904D2157F1AD6896.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Dtpo_Synpoamt3E9EEB205AAA4ABF904D2157F1AD6896(response, vars, strC_Order_ID, stremDtpoSynpoamt, strProcessing);
        }
    ...
    } else if (vars.commandIn("BUTTONEM_Dtpo_Ammendment8E4F47F66A4241E08C5F169D0AC3F20F")) {
        vars.setSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.stremDtpoAmmendment", vars.getStringParameter("inpemDtpoAmmendment"));
        vars.setSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button8E4F47F66A4241E08C5F169D0AC3F20F.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "8E4F47F66A4241E08C5F169D0AC3F20F", request.getServletPath());
      } else if (vars.commandIn("BUTTON8E4F47F66A4241E08C5F169D0AC3F20F")) {
        String strC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID", "");
        String stremDtpoAmmendment = vars.getSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.stremDtpoAmmendment");
        String strProcessing = vars.getSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.strProcessing");
        String strOrg = vars.getSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.strOrg");
        String strClient = vars.getSessionValue("button8E4F47F66A4241E08C5F169D0AC3F20F.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Dtpo_Ammendment8E4F47F66A4241E08C5F169D0AC3F20F(response, vars, strC_Order_ID, stremDtpoAmmendment, strProcessing);
        }
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Dtpo_Synpoamt3E9EEB205AAA4ABF904D2157F1AD6896")) {
        String strC_Order_ID = vars.getGlobalVariable("inpKey", windowId + "|C_Order_ID", "");
        @SuppressWarnings("unused")
        String stremDtpoSynpoamt = vars.getStringParameter("inpemDtpoSynpoamt");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "3E9EEB205AAA4ABF904D2157F1AD6896", (("C_Order_ID".equalsIgnoreCase("AD_Language"))?"0":strC_Order_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
params.put("recalculateprices", strrecalculateprices);
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Dtpo_Ammendment8E4F47F66A4241E08C5F169D0AC3F20F")) {
        String strC_Order_ID = vars.getGlobalVariable("inpKey", windowId + "|C_Order_ID", "");
        
        ProcessBundle pb = new ProcessBundle("8E4F47F66A4241E08C5F169D0AC3F20F", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
...
xmlDocument.setParameter("EM_Dtpo_Synpoamt_BTNname", Utility.getButtonName(this, vars, "286C3E3DBCEA4F01A99E8D24060AA824", "EM_Dtpo_Synpoamt_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Dtpo_Synpoamt = org.openbravo.erpCommon.utility.Utility.isModalProcess("3E9EEB205AAA4ABF904D2157F1AD6896"); 
xmlDocument.setParameter("EM_Dtpo_Synpoamt_Modal", modalEM_Dtpo_Synpoamt?"true":"false");
comboTableData = new ComboTableData(vars, this, "18", "EM_Dtpo_C_Tax_ID", "F742024708024FB4B56CF922DC39AE5D", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emDtpoCTaxId"):dataField.getField("emDtpoCTaxId")));
xmlDocument.setData("reportEM_Dtpo_C_Tax_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "17", "EM_Dtpo_Orderscenario", "A4642E2FBFF0410AA80B3B6A0D027006", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emDtpoOrderscenario"):dataField.getField("emDtpoOrderscenario")));
xmlDocument.setData("reportEM_Dtpo_Orderscenario","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
xmlDocument.setParameter("EM_Dtpo_Ammendment_BTNname", Utility.getButtonName(this, vars, "9A1FEA5E903A44449DAF314FF758BDEF", "EM_Dtpo_Ammendment_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Dtpo_Ammendment = org.openbravo.erpCommon.utility.Utility.isModalProcess("8E4F47F66A4241E08C5F169D0AC3F20F"); 
xmlDocument.setParameter("EM_Dtpo_Ammendment_Modal", modalEM_Dtpo_Ammendment?"true":"false");
xmlDocument.setParameter("buttonEM_Dtpo_Conversionrate", Utility.messageBD(this, "Calc", vars.getLanguage()));
...
xmlDocument.setParameter("array", dact.toString());
    ...
    private void printPageButtonEM_Dtpo_Synpoamt3E9EEB205AAA4ABF904D2157F1AD6896(HttpServletResponse response, VariablesSecureApp vars, String strC_Order_ID, String stremDtpoSynpoamt, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 3E9EEB205AAA4ABF904D2157F1AD6896");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Dtpo_Synpoamt3E9EEB205AAA4ABF904D2157F1AD6896", discard).createXmlDocument();
      xmlDocument.setParameter("key", strC_Order_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "3E9EEB205AAA4ABF904D2157F1AD6896");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("3E9EEB205AAA4ABF904D2157F1AD6896");
        vars.removeMessage("3E9EEB205AAA4ABF904D2157F1AD6896");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
...
comboTableData = null;
    ...
    void printPageButtonEM_Dtpo_Ammendment8E4F47F66A4241E08C5F169D0AC3F20F(HttpServletResponse response, VariablesSecureApp vars, String strC_Order_ID, String stremDtpoAmmendment, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 8E4F47F66A4241E08C5F169D0AC3F20F");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Dtpo_Ammendment8E4F47F66A4241E08C5F169D0AC3F20F", discard).createXmlDocument();
      xmlDocument.setParameter("key", strC_Order_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "8E4F47F66A4241E08C5F169D0AC3F20F");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("8E4F47F66A4241E08C5F169D0AC3F20F");
        vars.removeMessage("8E4F47F66A4241E08C5F169D0AC3F20F");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
