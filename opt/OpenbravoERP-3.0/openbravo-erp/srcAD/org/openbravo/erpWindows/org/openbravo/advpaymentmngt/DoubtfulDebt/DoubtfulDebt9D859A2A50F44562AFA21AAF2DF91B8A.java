...
public class DoubtfulDebt9D859A2A50F44562AFA21AAF2DF91B8A extends HttpSecureAppServlet {
  ...
  private static Logger log4j = Logger.getLogger(DoubtfulDebt9D859A2A50F44562AFA21AAF2DF91B8A.class);
  ...
  private DoubtfulDebt9D859A2A50F44562AFA21AAF2DF91B8AData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|EM_APRM_Process", data[0].getField("emAprmProcess"));    vars.setSessionValue(windowId + "|FIN_Doubtful_Debt_ID", data[0].getField("finDoubtfulDebtId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strFIN_Doubtful_Debt_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
