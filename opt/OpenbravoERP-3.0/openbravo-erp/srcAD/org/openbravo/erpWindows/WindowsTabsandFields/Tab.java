...
String strParamAD_Window_ID = vars.getSessionValue(tabId + "|paramAD_Window_ID");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("adTabId") == null || dataField.getField("adTabId").equals("")) {
        ...
        String strIsTreeTable = TabData.selectAux364291215E9147639E19489DCE02B97F(this, ((dataField!=null)?dataField.getField("adTableId"):((data==null || data.length==0)?"":data[0].adTableId)));
