...
String strParamPaymentdate_f = vars.getSessionValue(tabId + "|paramPaymentdate_f");
    ...
    vars.setSessionValue(windowId + "|FIN_ISRECEIPT", strFIN_ISRECEIPT);
        String strFinancialAccountCurrencyId = HeaderData.selectAuxFF8080812E26BF58012E2772F0B2003B(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].finFinancialAccountId)));
    vars.setSessionValue(windowId + "|FinancialAccountCurrencyId", strFinancialAccountCurrencyId);
        String strIsMultiCurrencyEnabled = HeaderData.selectAuxFF8080812E26BF58012E27DDC44E0170(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].finFinancialAccountId)), ((dataField!=null)?dataField.getField("finPaymentmethodId"):((data==null || data.length==0)?"":data[0].finPaymentmethodId)));
...
xmlDocument.setParameter("EM_Aprm_Add_Scheduledpayments_BTNname", Utility.getButtonName(this, vars, "7FCAAFE989BDA375E040007F01007F0A", "EM_Aprm_Add_Scheduledpayments_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_Add_Scheduledpayments = org.openbravo.erpCommon.utility.Utility.isModalProcess("12016E2EDE0245B5A36B84CBA144DBDF"); 
