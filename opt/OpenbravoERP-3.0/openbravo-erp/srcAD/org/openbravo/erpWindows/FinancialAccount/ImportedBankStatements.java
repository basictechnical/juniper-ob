...
params.put("action", straction);
  ...
  private String getParentID(VariablesSecureApp vars, String strFIN_Bankstatement_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|EM_APRM_Process_BS_Force", data[0].getField("emAprmProcessBsForce"));    vars.setSessionValue(windowId + "|EM_APRM_Process_BS", data[0].getField("emAprmProcessBs"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|FIN_Bankstatement_ID", data[0].getField("finBankstatementId"));
    }
...
String strParamStatementdate_f = vars.getSessionValue(tabId + "|paramStatementdate_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("finBankstatementId") == null || dataField.getField("finBankstatementId").equals("")) {
        ...
        String strAPRM_ISRECONCILED = ImportedBankStatementsData.selectAuxB1C25B989C164EDFB7F9B26CB799DDAA(this, ((dataField!=null)?dataField.getField("finBankstatementId"):((data==null || data.length==0)?"":data[0].finBankstatementId)), strPFIN_Financial_Account_ID);
