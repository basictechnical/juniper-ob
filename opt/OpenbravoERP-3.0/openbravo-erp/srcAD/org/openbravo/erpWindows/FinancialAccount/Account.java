...
String strParamC_Currency_ID = vars.getSessionValue(tabId + "|paramC_Currency_ID");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("finFinancialAccountId") == null || dataField.getField("finFinancialAccountId").equals("")) {
        ...
        String strDRAFTRECONCILIATION = AccountData.selectAux1FF62A68BA95425CA76E4317DD195C62(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].finFinancialAccountId)));
    vars.setSessionValue(windowId + "|DRAFTRECONCILIATION", strDRAFTRECONCILIATION);
        String strLASTRECON = AccountData.selectAux4FD70C86888041D695C59CFA792BBCC6(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].finFinancialAccountId)));
...
xmlDocument.setParameter("EM_APRM_MatchTrans_Force_BTNname", Utility.getButtonName(this, vars, "B7C06E2CD9EC460FBA493804E274ACC7", "EM_APRM_MatchTrans_Force_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_MatchTrans_Force = org.openbravo.erpCommon.utility.Utility.isModalProcess("19EEA22FCA464979B3ADAD3A967ADA52"); 
