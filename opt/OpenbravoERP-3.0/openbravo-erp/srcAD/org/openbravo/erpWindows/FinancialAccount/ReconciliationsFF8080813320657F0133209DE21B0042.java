...
String strParamStatementdate_f = vars.getSessionValue(tabId + "|paramStatementdate_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("finReconciliationId") == null || dataField.getField("finReconciliationId").equals("")) {
        ...
        String strISMANUAL = ReconciliationsFF8080813320657F0133209DE21B0042Data.selectAux1570DEA796EC4EE0A9AB562BC2E14C66(this, ((dataField!=null)?dataField.getField("finReconciliationId"):((data==null || data.length==0)?"":data[0].finReconciliationId)));
