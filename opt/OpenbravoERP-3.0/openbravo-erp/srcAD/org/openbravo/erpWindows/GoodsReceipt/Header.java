  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("852A3638379F4A99AF086D293A0A6D6A")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("852A3638379F4A99AF086D293A0A6D6A");
        SessionInfo.setModuleId("7B984714AD4D42B6B410D20BEFDB154F");
        if (securedProcess || explicitAccess.contains("852A3638379F4A99AF086D293A0A6D6A")) {
          classInfo.type = "P";
          classInfo.id = "852A3638379F4A99AF086D293A0A6D6A";
        }
      }
...
vars.getRequestGlobalVariable("inpParamMovementDate_f", tabId + "|paramMovementDate_f");
      ...
      response.sendRedirect(strDireccion + request.getServletPath());
     ...
     } else if (vars.commandIn("BUTTONEM_Dtpo_Linesfromcop852A3638379F4A99AF086D293A0A6D6A")) {
        vars.setSessionValue("button852A3638379F4A99AF086D293A0A6D6A.stremDtpoLinesfromcop", vars.getStringParameter("inpemDtpoLinesfromcop"));
        vars.setSessionValue("button852A3638379F4A99AF086D293A0A6D6A.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button852A3638379F4A99AF086D293A0A6D6A.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button852A3638379F4A99AF086D293A0A6D6A.strClient", vars.getStringParameter("inpadClientId"));
        
        
        HashMap<String, String> p = new HashMap<String, String>();
        p.put("C_order_ID", vars.getStringParameter("inpcOrderId"));

        
        //Save in session needed params for combos if needed
        vars.setSessionObject("button852A3638379F4A99AF086D293A0A6D6A.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "852A3638379F4A99AF086D293A0A6D6A", request.getServletPath());    
     } else if (vars.commandIn("BUTTON852A3638379F4A99AF086D293A0A6D6A")) {
        String strM_InOut_ID = vars.getGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID", "");
        String stremDtpoLinesfromcop = vars.getSessionValue("button852A3638379F4A99AF086D293A0A6D6A.stremDtpoLinesfromcop");
        String strProcessing = vars.getSessionValue("button852A3638379F4A99AF086D293A0A6D6A.strProcessing");
        String strOrg = vars.getSessionValue("button852A3638379F4A99AF086D293A0A6D6A.strOrg");
        String strClient = vars.getSessionValue("button852A3638379F4A99AF086D293A0A6D6A.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Dtpo_Linesfromcop852A3638379F4A99AF086D293A0A6D6A(response, vars, strM_InOut_ID, stremDtpoLinesfromcop, strProcessing);
        }
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "M_PriceList_Version_ID", strmPricelistVersionId, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Dtpo_Linesfromcop852A3638379F4A99AF086D293A0A6D6A")) {
        String strM_InOut_ID = vars.getGlobalVariable("inpKey", windowId + "|M_InOut_ID", "");
        @SuppressWarnings("unused")
        String stremDtpoLinesfromcop = vars.getStringParameter("inpemDtpoLinesfromcop");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "852A3638379F4A99AF086D293A0A6D6A", (("M_InOut_ID".equalsIgnoreCase("AD_Language"))?"0":strM_InOut_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
String strdtpoPocopfileId = vars.getStringParameter("inpdtpoPocopfileId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "Dtpo_Pocopfile_ID", strdtpoPocopfileId, vars.getClient(), vars.getOrg(), vars.getUser());
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    vars.setSessionValue(windowId + "|ISLOGISTICAUX", strISLOGISTICAUX);
        String strDOCBASETYPE = HeaderData.selectAux343D4CF5B66246348ECF5F82D201E9C6(this, ((dataField!=null)?dataField.getField("cDoctypeId"):((data==null || data.length==0)?"":data[0].cDoctypeId)));
...
xmlDocument.setParameter("EM_Dtpo_Linesfromcop_BTNname", Utility.getButtonName(this, vars, "9204A582A3A849EDB976095A0025EFD6", "EM_Dtpo_Linesfromcop_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Dtpo_Linesfromcop = org.openbravo.erpCommon.utility.Utility.isModalProcess("852A3638379F4A99AF086D293A0A6D6A"); 
xmlDocument.setParameter("EM_Dtpo_Linesfromcop_Modal", modalEM_Dtpo_Linesfromcop?"true":"false");
...
comboTableData = null;
    ...
    private void printPageButtonEM_Dtpo_Linesfromcop852A3638379F4A99AF086D293A0A6D6A(HttpServletResponse response, VariablesSecureApp vars, String strM_InOut_ID, String stremDtpoLinesfromcop, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 852A3638379F4A99AF086D293A0A6D6A");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Dtpo_Linesfromcop852A3638379F4A99AF086D293A0A6D6A", discard).createXmlDocument();
      xmlDocument.setParameter("key", strM_InOut_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "852A3638379F4A99AF086D293A0A6D6A");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("852A3638379F4A99AF086D293A0A6D6A");
        vars.removeMessage("852A3638379F4A99AF086D293A0A6D6A");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
    ...
    comboTableData = new ComboTableData(vars, this, "19", "C_order_ID", "", "BA217B25A936410981CAE8E4E4114B90", Utility.getContext(this, vars, "#AccessibleOrgTree", ""), Utility.getContext(this, vars, "#User_Client", ""), 0);
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button852A3638379F4A99AF086D293A0A6D6A.originalParams"), comboTableData, windowId, "");
    xmlDocument.setData("reportC_order_ID", "liststructure", comboTableData.select(false));
comboTableData = null;
    xmlDocument.setParameter("Dtpo_Pocopfile_ID", "");
    comboTableData = new ComboTableData(vars, this, "19", "Dtpo_Pocopfile_ID", "", "C683F599556B40DE9C0B95CF3E49DDED", Utility.getContext(this, vars, "#AccessibleOrgTree", ""), Utility.getContext(this, vars, "#User_Client", ""), 0);
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button852A3638379F4A99AF086D293A0A6D6A.originalParams"), comboTableData, windowId, "");
    xmlDocument.setData("reportDtpo_Pocopfile_ID", "liststructure", comboTableData.select(false));
comboTableData = null;
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
