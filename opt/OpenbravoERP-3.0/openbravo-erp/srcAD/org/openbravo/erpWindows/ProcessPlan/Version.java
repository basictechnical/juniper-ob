...
public class Version extends HttpSecureAppServlet {
  ...
  private static Logger log4j = Logger.getLogger(Version.class);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strMA_Processplan_Version_ID, String strPMA_Processplan_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
