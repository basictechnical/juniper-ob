...
params.put("copyattribute", strcopyattribute);
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Sequenceproduct_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|Line", data[0].getField("line"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|MA_Sequenceproduct_ID", data[0].getField("maSequenceproductId"));
    }
