...
public class Requisition extends HttpSecureAppServlet {
  ...
  private static Logger log4j = Logger.getLogger(Requisition.class);
...
String stradTableId = "800212";
  ...
  private RequisitionData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.emDtProjectId = vars.getRequestGlobalVariable("inpemDtProjectId", windowId + "|EM_DT_Project_ID");     data.emDtProjectIdr = vars.getStringParameter("inpemDtProjectId_R");     data.description = vars.getStringParameter("inpdescription");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.adUserId = vars.getRequiredStringParameter("inpadUserId");     data.adUserIdr = vars.getStringParameter("inpadUserId_R");     data.mPricelistId = vars.getRequestGlobalVariable("inpmPricelistId", windowId + "|M_PriceList_ID");     data.mPricelistIdr = vars.getStringParameter("inpmPricelistId_R");     data.cCurrencyId = vars.getRequestGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.cCurrencyIdr = vars.getStringParameter("inpcCurrencyId_R");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.docstatus = vars.getRequiredStringParameter("inpdocstatus");     data.emPcProjectId = vars.getRequestGlobalVariable("inpemPcProjectId", windowId + "|EM_Pc_Project_ID");     data.emPcProjectIdr = vars.getStringParameter("inpemPcProjectId_R");     data.emEpbMainsectionId = vars.getStringParameter("inpemEpbMainsectionId");     data.emEpbSubsectionId = vars.getStringParameter("inpemEpbSubsectionId");     data.emEpbSubtasksId = vars.getStringParameter("inpemEpbSubtasksId");     data.emPcIscheck = vars.getStringParameter("inpemPcIscheck", "N");     data.createpo = vars.getRequiredStringParameter("inpcreatepo");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.mRequisitionId = vars.getRequestGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID");     data.processing = vars.getStringParameter("inpprocessing", "N");     data.isactive = vars.getStringParameter("inpisactive", "N"); 
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = RequisitionData.set(Utility.getDefault(this, vars, "Createpo", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "800092", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField))), Utility.getDefault(this, vars, "Processed", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "AD_User_ID", "@#AD_User_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "Processing", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "EM_Epb_Mainsection_ID", "", "800092", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800092", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField), RequisitionData.selectDef803534_0(this, Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField), RequisitionData.selectDef803536_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Description", "", "800092", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "", dataField), RequisitionData.selectDef803539_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_DT_Project_ID", "", "800092", "", dataField), RequisitionData.selectDef982395F7004F4104A9469C94E6AF4D66_3(this, Utility.getDefault(this, vars, "EM_DT_Project_ID", "", "800092", "", dataField)), Utility.getDefault(this, vars, "EM_Epb_Subtasks_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Epb_Subsection_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Pc_Project_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Pc_Ischeck", "", "800092", "N", dataField));
...
comboTableData = new ComboTableData(vars, this, "18", "EM_Pc_Project_ID", "B6590DBA558F489C8BEDC34CC87C377F", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emPcProjectId"):dataField.getField("emPcProjectId")));
xmlDocument.setData("reportEM_Pc_Project_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
