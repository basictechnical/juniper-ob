...
Select for auxiliar field
 */
  public static String selectDef1636(ConnectionProvider connectionProvider, String C_Period_ID, String AD_Client_ID, String AD_Org_ID, String DateAcct)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE GL_Journal" +
      "        SET AD_Org_ID = (?) , C_AcctSchema_ID = (?) , DocumentNo = (?) , Description = (?) , C_DocType_ID = (?) , DateDoc = TO_DATE(?) , DateAcct = TO_DATE(?) , C_Period_ID = (?) , C_Currency_ID = (?) , CurrencyRateType = (?) , CurrencyRate = TO_NUMBER(?) , IsOpening = (?) , TotalDr = TO_NUMBER(?) , ControlAmt = TO_NUMBER(?) , DocAction = (?) , TotalCr = TO_NUMBER(?) , DocStatus = (?) , Posted = (?) , IsActive = (?) , IsPrinted = (?) , GL_Category_ID = (?) , IsApproved = (?) , C_Bpartner_ID = (?) , M_Product_ID = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , C_Campaign_ID = (?) , User1_ID = (?) , User2_ID = (?) , GL_Journal_ID = (?) , PostingType = (?) , Processed = (?) , Processing = (?) , AD_Client_ID = (?) , GL_JournalBatch_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE GL_Journal.GL_Journal_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_AcctSchema_ID, DocumentNo, Description, C_DocType_ID, DateDoc, DateAcct, C_Period_ID, C_Currency_ID, CurrencyRateType, CurrencyRate, IsOpening, TotalDr, ControlAmt, DocAction, TotalCr, DocStatus, Posted, IsActive, IsPrinted, GL_Category_ID, IsApproved, C_Bpartner_ID, M_Product_ID, C_Project_ID, C_Costcenter_ID, A_Asset_ID, C_Campaign_ID, User1_ID, User2_ID, GL_Journal_ID, PostingType, Processed, Processing, AD_Client_ID, GL_JournalBatch_ID, created, createdby, updated, updatedBy)" +
