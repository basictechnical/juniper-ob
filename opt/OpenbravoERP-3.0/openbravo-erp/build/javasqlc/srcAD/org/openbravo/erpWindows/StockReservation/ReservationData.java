 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET RES_Process = (?) , AD_Org_ID = (?) , M_Product_ID = (?) , Quantity = TO_NUMBER(?) , C_Uom_ID = (?) , C_Orderline_ID = (?) , M_Warehouse_ID = (?) , M_Locator_ID = (?) , M_Attributesetinstance_ID = (?) , Reservedgoodmnt_Pe = (?) , Managereservation_Pe = (?) , RES_Status = (?) , M_Reservation_ID = (?) , Isactive = (?) , Reservedqty = TO_NUMBER(?) , ReleasedQty = TO_NUMBER(?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (RES_Process, AD_Org_ID, M_Product_ID, Quantity, C_Uom_ID, C_Orderline_ID, M_Warehouse_ID, M_Locator_ID, M_Attributesetinstance_ID, Reservedgoodmnt_Pe, Managereservation_Pe, RES_Status, M_Reservation_ID, Isactive, Reservedqty, ReleasedQty, AD_Client_ID, created, createdby, updated, updatedBy)" +
