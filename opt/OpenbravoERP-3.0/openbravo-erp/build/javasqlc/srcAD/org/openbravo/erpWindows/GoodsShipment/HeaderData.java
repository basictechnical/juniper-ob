...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String emDtLorryno;
  public String emDtTrpname;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_dt_lorryno") || fieldName.equals("emDtLorryno"))
      return emDtLorryno;
    else if (fieldName.equalsIgnoreCase("em_dt_trpname") || fieldName.equals("emDtTrpname"))
      return emDtTrpname;
 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_InOut.EM_Dt_Lorryno, " +
      "M_InOut.EM_Dt_Trpname, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.emDtLorryno = UtilSql.getValue(result, "em_dt_lorryno");
        objectHeaderData.emDtTrpname = UtilSql.getValue(result, "em_dt_trpname");
 ...
 */
  public static HeaderData[] set(String freightCurrencyId, String emDtTrpname, String processGoodsJava, String processGoodsJavaBtn, String emDtLorryno, String description, String movementtype, String movementdate, String processed, String processing, String mInoutId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String issotrx, String documentno, String cDoctypeId, String isprinted, String dateacct, String cBpartnerId, String cBpartnerIdr, String cBpartnerLocationId, String adUserId, String mWarehouseId, String poreference, String deliveryrule, String freightcostrule, String freightamt, String deliveryviarule, String mShipperId, String cChargeId, String chargeamt, String priorityrule, String dateprinted, String cOrderId, String cOrderIdr, String mConditionGoodsId, String dateordered, String docstatus, String docaction, String createfrom, String generateto, String cInvoiceId, String posted, String postedBtn, String updatelines, String islogistic, String generatelines, String deliveryLocationId, String mFreightcategoryId, String calculateFreight, String salesrepId, String cCostcenterId, String pickdate, String trackingno, String nopackages, String shipdate, String user2Id, String user1Id, String cActivityId, String cCampaignId, String cProjectId, String cProjectIdr, String adOrgtrxId, String rmReceiptPickedit, String rmShipmentPickedit, String aAssetId)    throws ServletException {
    ...
    objectHeaderData[0].emDtLorryno = emDtLorryno;
    objectHeaderData[0].emDtTrpname = emDtTrpname;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOut" +
      "        SET AD_Org_ID = (?) , C_DocType_ID = (?) , DocumentNo = (?) , M_Condition_Goods_ID = (?) , M_Warehouse_ID = (?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , Description = (?) , MovementDate = TO_DATE(?) , Delivery_Location_ID = (?) , DocStatus = (?) , AD_User_ID = (?) , DateAcct = TO_DATE(?) , C_Order_ID = (?) , POReference = (?) , DateOrdered = TO_DATE(?) , SalesRep_ID = (?) , CreateFrom = (?) , Process_Goods_Java = (?) , DocAction = (?) , Posted = (?) , DeliveryRule = (?) , DeliveryViaRule = (?) , FreightAmt = TO_NUMBER(?) , FreightCostRule = (?) , M_Shipper_ID = (?) , PriorityRule = (?) , PickDate = TO_TIMESTAMP(?, ?) , TrackingNo = (?) , NoPackages = TO_NUMBER(?) , MovementType = (?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , ShipDate = TO_TIMESTAMP(?, ?) , C_Activity_ID = (?) , C_Campaign_ID = (?) , AD_OrgTrx_ID = (?) , M_FreightCategory_ID = (?) , Calculate_Freight = (?) , Freight_Currency_ID = (?) , EM_Dt_Lorryno = (?) , EM_Dt_Trpname = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , User1_ID = (?) , User2_ID = (?) , Processing = (?) , C_Invoice_ID = (?) , IsSOTrx = (?) , DatePrinted = TO_DATE(?) , Islogistic = (?) , RM_Receipt_PickEdit = (?) , RM_Shipment_Pickedit = (?) , Processed = (?) , M_InOut_ID = (?) , GenerateLines = (?) , UpdateLines = (?) , GenerateTo = (?) , IsActive = (?) , AD_Client_ID = (?) , IsPrinted = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtLorryno);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtTrpname);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO M_InOut " +
      "        (AD_Org_ID, C_DocType_ID, DocumentNo, M_Condition_Goods_ID, M_Warehouse_ID, C_BPartner_ID, C_BPartner_Location_ID, Description, MovementDate, Delivery_Location_ID, DocStatus, AD_User_ID, DateAcct, C_Order_ID, POReference, DateOrdered, SalesRep_ID, CreateFrom, Process_Goods_Java, DocAction, Posted, DeliveryRule, DeliveryViaRule, FreightAmt, FreightCostRule, M_Shipper_ID, PriorityRule, PickDate, TrackingNo, NoPackages, MovementType, C_Charge_ID, ChargeAmt, ShipDate, C_Activity_ID, C_Campaign_ID, AD_OrgTrx_ID, M_FreightCategory_ID, Calculate_Freight, Freight_Currency_ID, EM_Dt_Lorryno, EM_Dt_Trpname, C_Project_ID, C_Costcenter_ID, A_Asset_ID, User1_ID, User2_ID, Processing, C_Invoice_ID, IsSOTrx, DatePrinted, Islogistic, RM_Receipt_PickEdit, RM_Shipment_Pickedit, Processed, M_InOut_ID, GenerateLines, UpdateLines, GenerateTo, IsActive, AD_Client_ID, IsPrinted, created, createdby, updated, updatedBy)" +
