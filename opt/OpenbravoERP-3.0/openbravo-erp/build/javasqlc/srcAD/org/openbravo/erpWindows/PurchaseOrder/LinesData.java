...
static Logger log4j = Logger.getLogger(LinesData.class);
  ...
  public String emPcRequisitionlineId;
  public String bomParentId;
  public String emDtpoCertfiedqty;
  public String emDtpoCopcumamt;
  public String emDtpoPendingamt;
  public String emDtpoPendingqty;
  public String emDtpoSearchkey;
  public String emDtpoInsurance;
  public String emDtpoFrieght;
  public String emDtpoPkg;
  public String emDtpoOthers;
  public String emDtpoTotal;
  public String emDtpoExcise;
  public String emDtpoVatCst;
  public String emDtpoCess;
  public String emDtpoServicetax;
  public String emDtpoSupplybasic;
  public String emDtpoExcisetotal;
  public String emDtpoSupplytotal;
  public String emDtpoInstallationbasic;
  public String emDtpoInstallationothers;
  public String emDtpoInstallationtotal;
  public String emDtpoSupplyamount;
  public String emDtpoInstallationamount;
  public String emDtpoImportbasic;
  public String emDtpoImportamount;
  public String emDtpoSupplyothers;
  public String emDtpoImporttotal;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return explode;
    else if (fieldName.equalsIgnoreCase("em_pc_requisitionline_id") || fieldName.equals("emPcRequisitionlineId"))
      return emPcRequisitionlineId;
    else if (fieldName.equalsIgnoreCase("bom_parent_id") || fieldName.equals("bomParentId"))
      return bomParentId;
    else if (fieldName.equalsIgnoreCase("em_dtpo_certfiedqty") || fieldName.equals("emDtpoCertfiedqty"))
      return emDtpoCertfiedqty;
    else if (fieldName.equalsIgnoreCase("em_dtpo_copcumamt") || fieldName.equals("emDtpoCopcumamt"))
      return emDtpoCopcumamt;
    else if (fieldName.equalsIgnoreCase("em_dtpo_pendingamt") || fieldName.equals("emDtpoPendingamt"))
      return emDtpoPendingamt;
    else if (fieldName.equalsIgnoreCase("em_dtpo_pendingqty") || fieldName.equals("emDtpoPendingqty"))
      return emDtpoPendingqty;
    else if (fieldName.equalsIgnoreCase("em_dtpo_searchkey") || fieldName.equals("emDtpoSearchkey"))
      return emDtpoSearchkey;
    else if (fieldName.equalsIgnoreCase("em_dtpo_insurance") || fieldName.equals("emDtpoInsurance"))
      return emDtpoInsurance;
    else if (fieldName.equalsIgnoreCase("em_dtpo_frieght") || fieldName.equals("emDtpoFrieght"))
      return emDtpoFrieght;
    else if (fieldName.equalsIgnoreCase("em_dtpo_pkg") || fieldName.equals("emDtpoPkg"))
      return emDtpoPkg;
    else if (fieldName.equalsIgnoreCase("em_dtpo_others") || fieldName.equals("emDtpoOthers"))
      return emDtpoOthers;
    else if (fieldName.equalsIgnoreCase("em_dtpo_total") || fieldName.equals("emDtpoTotal"))
      return emDtpoTotal;
    else if (fieldName.equalsIgnoreCase("em_dtpo_excise") || fieldName.equals("emDtpoExcise"))
      return emDtpoExcise;
    else if (fieldName.equalsIgnoreCase("em_dtpo_vat_cst") || fieldName.equals("emDtpoVatCst"))
      return emDtpoVatCst;
    else if (fieldName.equalsIgnoreCase("em_dtpo_cess") || fieldName.equals("emDtpoCess"))
      return emDtpoCess;
    else if (fieldName.equalsIgnoreCase("em_dtpo_servicetax") || fieldName.equals("emDtpoServicetax"))
      return emDtpoServicetax;
    else if (fieldName.equalsIgnoreCase("em_dtpo_supplybasic") || fieldName.equals("emDtpoSupplybasic"))
      return emDtpoSupplybasic;
    else if (fieldName.equalsIgnoreCase("em_dtpo_excisetotal") || fieldName.equals("emDtpoExcisetotal"))
      return emDtpoExcisetotal;
    else if (fieldName.equalsIgnoreCase("em_dtpo_supplytotal") || fieldName.equals("emDtpoSupplytotal"))
      return emDtpoSupplytotal;
    else if (fieldName.equalsIgnoreCase("em_dtpo_installationbasic") || fieldName.equals("emDtpoInstallationbasic"))
      return emDtpoInstallationbasic;
    else if (fieldName.equalsIgnoreCase("em_dtpo_installationothers") || fieldName.equals("emDtpoInstallationothers"))
      return emDtpoInstallationothers;
    else if (fieldName.equalsIgnoreCase("em_dtpo_installationtotal") || fieldName.equals("emDtpoInstallationtotal"))
      return emDtpoInstallationtotal;
    else if (fieldName.equalsIgnoreCase("em_dtpo_supplyamount") || fieldName.equals("emDtpoSupplyamount"))
      return emDtpoSupplyamount;
    else if (fieldName.equalsIgnoreCase("em_dtpo_installationamount") || fieldName.equals("emDtpoInstallationamount"))
      return emDtpoInstallationamount;
    else if (fieldName.equalsIgnoreCase("em_dtpo_importbasic") || fieldName.equals("emDtpoImportbasic"))
      return emDtpoImportbasic;
    else if (fieldName.equalsIgnoreCase("em_dtpo_importamount") || fieldName.equals("emDtpoImportamount"))
      return emDtpoImportamount;
    else if (fieldName.equalsIgnoreCase("em_dtpo_supplyothers") || fieldName.equals("emDtpoSupplyothers"))
      return emDtpoSupplyothers;
    else if (fieldName.equalsIgnoreCase("em_dtpo_importtotal") || fieldName.equals("emDtpoImporttotal"))
      return emDtpoImporttotal;
  ...
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cOrderId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLinesData.emPcRequisitionlineId = UtilSql.getValue(result, "em_pc_requisitionline_id");
        objectLinesData.bomParentId = UtilSql.getValue(result, "bom_parent_id");
        objectLinesData.emDtpoCertfiedqty = UtilSql.getValue(result, "em_dtpo_certfiedqty");
        objectLinesData.emDtpoCopcumamt = UtilSql.getValue(result, "em_dtpo_copcumamt");
        objectLinesData.emDtpoPendingamt = UtilSql.getValue(result, "em_dtpo_pendingamt");
        objectLinesData.emDtpoPendingqty = UtilSql.getValue(result, "em_dtpo_pendingqty");
        objectLinesData.emDtpoSearchkey = UtilSql.getValue(result, "em_dtpo_searchkey");
        objectLinesData.emDtpoInsurance = UtilSql.getValue(result, "em_dtpo_insurance");
        objectLinesData.emDtpoFrieght = UtilSql.getValue(result, "em_dtpo_frieght");
        objectLinesData.emDtpoPkg = UtilSql.getValue(result, "em_dtpo_pkg");
        objectLinesData.emDtpoOthers = UtilSql.getValue(result, "em_dtpo_others");
        objectLinesData.emDtpoTotal = UtilSql.getValue(result, "em_dtpo_total");
        objectLinesData.emDtpoExcise = UtilSql.getValue(result, "em_dtpo_excise");
        objectLinesData.emDtpoVatCst = UtilSql.getValue(result, "em_dtpo_vat_cst");
        objectLinesData.emDtpoCess = UtilSql.getValue(result, "em_dtpo_cess");
        objectLinesData.emDtpoServicetax = UtilSql.getValue(result, "em_dtpo_servicetax");
        objectLinesData.emDtpoSupplybasic = UtilSql.getValue(result, "em_dtpo_supplybasic");
        objectLinesData.emDtpoExcisetotal = UtilSql.getValue(result, "em_dtpo_excisetotal");
        objectLinesData.emDtpoSupplytotal = UtilSql.getValue(result, "em_dtpo_supplytotal");
        objectLinesData.emDtpoInstallationbasic = UtilSql.getValue(result, "em_dtpo_installationbasic");
        objectLinesData.emDtpoInstallationothers = UtilSql.getValue(result, "em_dtpo_installationothers");
        objectLinesData.emDtpoInstallationtotal = UtilSql.getValue(result, "em_dtpo_installationtotal");
        objectLinesData.emDtpoSupplyamount = UtilSql.getValue(result, "em_dtpo_supplyamount");
        objectLinesData.emDtpoInstallationamount = UtilSql.getValue(result, "em_dtpo_installationamount");
        objectLinesData.emDtpoImportbasic = UtilSql.getValue(result, "em_dtpo_importbasic");
        objectLinesData.emDtpoImportamount = UtilSql.getValue(result, "em_dtpo_importamount");
        objectLinesData.emDtpoSupplyothers = UtilSql.getValue(result, "em_dtpo_supplyothers");
        objectLinesData.emDtpoImporttotal = UtilSql.getValue(result, "em_dtpo_importtotal");
...
Create a registry
 */
  public static LinesData[] set(String cOrderId, String emDtpoImportbasic, String lineGrossAmount, String emDtpoPendingqty, String emDtpoInstallationamount, String cancelpricead, String cOrderlineId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String line, String dateordered, String datepromised, String datedelivered, String dateinvoiced, String description, String mProductId, String mProductIdr, String cUomId, String mWarehouseId, String qtyordered, String qtyreserved, String qtydelivered, String qtyinvoiced, String mShipperId, String cCurrencyId, String pricelist, String priceactual, String cTaxId, String cBpartnerId, String directship, String freightamt, String cChargeId, String chargeamt, String cBpartnerLocationId, String linenetamt, String emDtpoInstallationbasic, String pricelimit, String discount, String emDtpoCopcumamt, String cCostcenterId, String emDtpoPkg, String emDtpoSupplybasic, String emDtpoInstallationtotal, String emDtpoImportamount, String emDtpoCess, String emDtpoSupplyothers, String cReturnReasonId, String emDtpoImporttotal, String sResourceassignmentId, String cOrderDiscountId, String emDtpoSupplytotal, String user2Id, String aAssetId, String refOrderlineId, String iseditlinenetamt, String taxbaseamt, String mProductUomId, String quantityorder, String mOfferId, String pricestd, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String user1Id, String emDtpoSupplyamount, String emDtpoPendingamt, String isdescription, String emDtpoVatCst, String emDtpoInstallationothers, String bomParentId, String grosspricestd, String emDtpoOthers, String emDtpoInsurance, String explode, String emDtpoExcisetotal, String mInoutlineId, String cProjectId, String cProjectIdr, String emDtpoExcise, String grosspricelist, String mWarehouseRuleId, String createReservation, String soResStatus, String manageReservation, String managePrereservation, String emDtpoServicetax, String emDtpoFrieght, String emDtpoTotal, String quotationlineId, String quotationlineIdr, String grossUnitPrice, String emDtpoCertfiedqty, String emPcRequisitionlineId, String emDtpoSearchkey)    throws ServletException {
    ...
    objectLinesData[0].emPcRequisitionlineId = emPcRequisitionlineId;
    objectLinesData[0].bomParentId = bomParentId;
    objectLinesData[0].emDtpoCertfiedqty = emDtpoCertfiedqty;
    objectLinesData[0].emDtpoCopcumamt = emDtpoCopcumamt;
    objectLinesData[0].emDtpoPendingamt = emDtpoPendingamt;
    objectLinesData[0].emDtpoPendingqty = emDtpoPendingqty;
    objectLinesData[0].emDtpoSearchkey = emDtpoSearchkey;
    objectLinesData[0].emDtpoInsurance = emDtpoInsurance;
    objectLinesData[0].emDtpoFrieght = emDtpoFrieght;
    objectLinesData[0].emDtpoPkg = emDtpoPkg;
    objectLinesData[0].emDtpoOthers = emDtpoOthers;
    objectLinesData[0].emDtpoTotal = emDtpoTotal;
    objectLinesData[0].emDtpoExcise = emDtpoExcise;
    objectLinesData[0].emDtpoVatCst = emDtpoVatCst;
    objectLinesData[0].emDtpoCess = emDtpoCess;
    objectLinesData[0].emDtpoServicetax = emDtpoServicetax;
    objectLinesData[0].emDtpoSupplybasic = emDtpoSupplybasic;
    objectLinesData[0].emDtpoExcisetotal = emDtpoExcisetotal;
    objectLinesData[0].emDtpoSupplytotal = emDtpoSupplytotal;
    objectLinesData[0].emDtpoInstallationbasic = emDtpoInstallationbasic;
    objectLinesData[0].emDtpoInstallationothers = emDtpoInstallationothers;
    objectLinesData[0].emDtpoInstallationtotal = emDtpoInstallationtotal;
    objectLinesData[0].emDtpoSupplyamount = emDtpoSupplyamount;
    objectLinesData[0].emDtpoInstallationamount = emDtpoInstallationamount;
    objectLinesData[0].emDtpoImportbasic = emDtpoImportbasic;
    objectLinesData[0].emDtpoImportamount = emDtpoImportamount;
    objectLinesData[0].emDtpoSupplyothers = emDtpoSupplyothers;
    objectLinesData[0].emDtpoImporttotal = emDtpoImporttotal;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emPcRequisitionlineId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, bomParentId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoCertfiedqty);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoCopcumamt);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoPendingamt);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoPendingqty);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoSearchkey);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoInsurance);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoFrieght);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoPkg);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoOthers);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoTotal);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoExcise);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoVatCst);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoCess);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoServicetax);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoSupplybasic);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoExcisetotal);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoSupplytotal);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoInstallationbasic);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoInstallationothers);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoInstallationtotal);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoSupplyamount);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoInstallationamount);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoImportbasic);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoImportamount);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoSupplyothers);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoImporttotal);
