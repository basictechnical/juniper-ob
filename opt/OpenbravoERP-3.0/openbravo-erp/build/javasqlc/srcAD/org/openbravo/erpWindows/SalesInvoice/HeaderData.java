...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String emDtIrnno;
  public String emDtPolicyno;
  public String emDtExcisechalan;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_dt_irnno") || fieldName.equals("emDtIrnno"))
      return emDtIrnno;
    else if (fieldName.equalsIgnoreCase("em_dt_policyno") || fieldName.equals("emDtPolicyno"))
      return emDtPolicyno;
    else if (fieldName.equalsIgnoreCase("em_dt_excisechalan") || fieldName.equals("emDtExcisechalan"))
      return emDtExcisechalan;
  ...
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.emDtIrnno = UtilSql.getValue(result, "em_dt_irnno");
        objectHeaderData.emDtPolicyno = UtilSql.getValue(result, "em_dt_policyno");
        objectHeaderData.emDtExcisechalan = UtilSql.getValue(result, "em_dt_excisechalan");
 ...
 */
  public static HeaderData[] set(String lastcalculatedondate, String cWithholdingId, String withholdingamount, String taxdate, String daystilldue, String cInvoiceId, String adClientId, String adOrgId, String isactive, String created, String createdby, String createdbyr, String updatedby, String updatedbyr, String documentno, String cDoctypeId, String docstatus, String docaction, String docactionBtn, String processing, String processed, String cBpartnerId, String cBpartnerIdr, String cPaymenttermId, String cBpartnerLocationId, String cCurrencyId, String totallines, String grandtotal, String dateacct, String cCampaignId, String cProjectId, String cProjectIdr, String cActivityId, String salesrepId, String adUserId, String emDtExcisechalan, String issotrx, String cDoctypetargetId, String description, String dateinvoiced, String dateprinted, String poreference, String cChargeId, String chargeamt, String mPricelistId, String paymentrule, String cOrderId, String cOrderIdr, String dateordered, String isdiscountprinted, String isprinted, String istaxincluded, String posted, String postedBtn, String generateto, String createfrom, String emAprmAddpayment, String finPaymentmethodId, String copyfrom, String isselfservice, String emAprmProcessinvoice, String emAprmProcessinvoiceBtn, String cCostcenterId, String adOrgtrxId, String user1Id, String user2Id, String finalsettlement, String daysoutstanding, String percentageoverdue, String totalpaid, String emDtPolicyno, String outstandingamt, String dueamt, String ispaid, String updatepaymentmonitor, String aAssetId, String emDtIrnno, String calculatePromotions)    throws ServletException {
    ...
    objectHeaderData[0].emDtIrnno = emDtIrnno;
    objectHeaderData[0].emDtPolicyno = emDtPolicyno;
    objectHeaderData[0].emDtExcisechalan = emDtExcisechalan;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtIrnno);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtPolicyno);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtExcisechalan);
