 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET SeqNo = TO_NUMBER(?) , MA_Measure_Shift_ID = (?) , MA_CCP_Group_ID = (?) , IsActive = (?) , AD_Org_ID = (?) , MA_Measure_Group_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE MA_Measure_Group.MA_Measure_Group_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (SeqNo, MA_Measure_Shift_ID, MA_CCP_Group_ID, IsActive, AD_Org_ID, MA_Measure_Group_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
