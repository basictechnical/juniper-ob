...
static Logger log4j = Logger.getLogger(ProductData.class);
  ...
  public String emIdljavaDesc;
  public String updateinvariants;
  public String emDtzkMake;
  public String emDtzkModel;
  public String emDtzkHsncode;
  public String emDtzkCountryorigin;
  public String emDtzkPortloading;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_idljava_desc") || fieldName.equals("emIdljavaDesc"))
      return emIdljavaDesc;
    else if (fieldName.equalsIgnoreCase("updateinvariants"))
      return updateinvariants;
    else if (fieldName.equalsIgnoreCase("em_dtzk_make") || fieldName.equals("emDtzkMake"))
      return emDtzkMake;
    else if (fieldName.equalsIgnoreCase("em_dtzk_model") || fieldName.equals("emDtzkModel"))
      return emDtzkModel;
    else if (fieldName.equalsIgnoreCase("em_dtzk_hsncode") || fieldName.equals("emDtzkHsncode"))
      return emDtzkHsncode;
    else if (fieldName.equalsIgnoreCase("em_dtzk_countryorigin") || fieldName.equals("emDtzkCountryorigin"))
      return emDtzkCountryorigin;
    else if (fieldName.equalsIgnoreCase("em_dtzk_portloading") || fieldName.equals("emDtzkPortloading"))
      return emDtzkPortloading;
 ...
 */
  public static ProductData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_Product.EM_Idljava_Desc, " +
      "M_Product.Updateinvariants, " +
      "M_Product.EM_Dtzk_Make, " +
      "M_Product.EM_Dtzk_Model, " +
      "M_Product.EM_Dtzk_Hsncode, " +
      "M_Product.EM_Dtzk_Countryorigin, " +
      "M_Product.EM_Dtzk_Portloading, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductData.emIdljavaDesc = UtilSql.getValue(result, "em_idljava_desc");
        objectProductData.updateinvariants = UtilSql.getValue(result, "updateinvariants");
        objectProductData.emDtzkMake = UtilSql.getValue(result, "em_dtzk_make");
        objectProductData.emDtzkModel = UtilSql.getValue(result, "em_dtzk_model");
        objectProductData.emDtzkHsncode = UtilSql.getValue(result, "em_dtzk_hsncode");
        objectProductData.emDtzkCountryorigin = UtilSql.getValue(result, "em_dtzk_countryorigin");
        objectProductData.emDtzkPortloading = UtilSql.getValue(result, "em_dtzk_portloading");
 ...
 */
  public static ProductData[] set(String emIdljavaDesc, String mProductId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String name, String description, String issummary, String cUomId, String isstocked, String ispurchased, String issold, String volume, String weight, String revplantype, String value, String mProductCategoryId, String cTaxcategoryId, String upc, String sku, String shelfwidth, String shelfheight, String shelfdepth, String unitsperpallet, String discontinued, String discontinuedby, String defaultperiod, String documentnote, String help, String classification, String salesrepId, String bookusingpoprice, String isbom, String isinvoiceprintdetails, String ispicklistprintdetails, String isverified, String processing, String capacity, String delaymin, String mrpPlannerId, String mrpPlanningmethodId, String qtymax, String qtymin, String qtystd, String qtytype, String stockmin, String sExpensetypeId, String sResourceId, String producttype, String imageurl, String descriptionurl, String versionno, String guaranteedays, String attrsetvaluetype, String adImageId, String cBpartnerId, String ispriceprinted, String name2, String costtype, String coststd, String stockMin, String enforceAttribute, String calculated, String maProcessplanId, String production, String isdeferredrevenue, String mAttributesetId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String downloadurl, String mFreightcategoryId, String mLocatorId, String emDtzkMake, String isdeferredexpense, String emDtzkCountryorigin, String defaultperiodExp, String expplantype, String periodnumberExp, String emDtzkHsncode, String updateinvariants, String mBrandId, String isgeneric, String genericProductId, String createvariants, String characteristicDesc, String managevariants, String cUomWeightId, String isquantityvariable, String emDtzkModel, String emDtzkPortloading, String periodnumber)    throws ServletException {
    ...
    objectProductData[0].emIdljavaDesc = emIdljavaDesc;
    objectProductData[0].updateinvariants = updateinvariants;
    objectProductData[0].emDtzkMake = emDtzkMake;
    objectProductData[0].emDtzkModel = emDtzkModel;
    objectProductData[0].emDtzkHsncode = emDtzkHsncode;
    objectProductData[0].emDtzkCountryorigin = emDtzkCountryorigin;
    objectProductData[0].emDtzkPortloading = emDtzkPortloading;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emIdljavaDesc);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, updateinvariants);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtzkMake);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtzkModel);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtzkHsncode);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtzkCountryorigin);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtzkPortloading);
