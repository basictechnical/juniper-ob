...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String emDtpoLinesfromcop;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return user2Id;
    else if (fieldName.equalsIgnoreCase("em_dtpo_linesfromcop") || fieldName.equals("emDtpoLinesfromcop"))
      return emDtpoLinesfromcop;
  ...
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.emDtpoLinesfromcop = UtilSql.getValue(result, "em_dtpo_linesfromcop");
 ...
 */
  public static HeaderData[] set(String freightCurrencyId, String processGoodsJava, String processGoodsJavaBtn, String description, String movementtype, String movementdate, String processed, String processing, String mInoutId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String issotrx, String documentno, String cDoctypeId, String isprinted, String dateacct, String cBpartnerId, String cBpartnerIdr, String cBpartnerLocationId, String adUserId, String mWarehouseId, String poreference, String deliveryrule, String freightcostrule, String freightamt, String deliveryviarule, String mShipperId, String cChargeId, String chargeamt, String priorityrule, String dateprinted, String cOrderId, String cOrderIdr, String mConditionGoodsId, String dateordered, String docstatus, String docaction, String createfrom, String generateto, String cInvoiceId, String posted, String postedBtn, String updatelines, String islogistic, String generatelines, String deliveryLocationId, String mFreightcategoryId, String calculateFreight, String salesrepId, String cCostcenterId, String emDtpoLinesfromcop, String pickdate, String trackingno, String nopackages, String shipdate, String user2Id, String user1Id, String cActivityId, String cCampaignId, String cProjectId, String cProjectIdr, String adOrgtrxId, String rmReceiptPickedit, String rmShipmentPickedit, String aAssetId)    throws ServletException {
    ...
    objectHeaderData[0].emDtpoLinesfromcop = emDtpoLinesfromcop;
...
Select for auxiliar field
 */
  public static String selectDef3798(ConnectionProvider connectionProvider, String m_warehouse_id, String ad_org_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select coalesce( warehouse,m_warehouse_id) as m_warehouse_id from ad_org_warehouse , (select min(m_warehouse_id) as warehouse from ad_org_warehouse where m_warehouse_id =? and  ad_org_id = ?) a where ad_org_id = ? group by m_warehouse_id, priority ,warehouse having min(priority) = priority  ";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOut" +
      "        SET AD_Org_ID = (?) , DocumentNo = (?) , M_Condition_Goods_ID = (?) , C_DocType_ID = (?) , M_Warehouse_ID = (?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , MovementDate = TO_DATE(?) , DateAcct = TO_DATE(?) , C_Order_ID = (?) , POReference = (?) , Description = (?) , DocStatus = (?) , AD_User_ID = (?) , CreateFrom = (?) , GenerateTo = (?) , Process_Goods_Java = (?) , DocAction = (?) , Posted = (?) , SalesRep_ID = (?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , DeliveryRule = (?) , DeliveryViaRule = (?) , FreightAmt = TO_NUMBER(?) , FreightCostRule = (?) , PriorityRule = (?) , MovementType = (?) , M_Shipper_ID = (?) , NoPackages = TO_NUMBER(?) , C_Activity_ID = (?) , C_Campaign_ID = (?) , AD_OrgTrx_ID = (?) , M_FreightCategory_ID = (?) , Calculate_Freight = (?) , Freight_Currency_ID = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , User1_ID = (?) , User2_ID = (?) , EM_Dtpo_Linesfromcop = (?) , Delivery_Location_ID = (?) , ShipDate = TO_TIMESTAMP(?, ?) , IsSOTrx = (?) , RM_Receipt_PickEdit = (?) , RM_Shipment_Pickedit = (?) , DatePrinted = TO_DATE(?) , Processed = (?) , TrackingNo = (?) , PickDate = TO_TIMESTAMP(?, ?) , IsPrinted = (?) , C_Invoice_ID = (?) , GenerateLines = (?) , M_InOut_ID = (?) , Processing = (?) , IsActive = (?) , DateOrdered = TO_DATE(?) , UpdateLines = (?) , AD_Client_ID = (?) , Islogistic = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoLinesfromcop);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO M_InOut " +
      "        (AD_Org_ID, DocumentNo, M_Condition_Goods_ID, C_DocType_ID, M_Warehouse_ID, C_BPartner_ID, C_BPartner_Location_ID, MovementDate, DateAcct, C_Order_ID, POReference, Description, DocStatus, AD_User_ID, CreateFrom, GenerateTo, Process_Goods_Java, DocAction, Posted, SalesRep_ID, C_Charge_ID, ChargeAmt, DeliveryRule, DeliveryViaRule, FreightAmt, FreightCostRule, PriorityRule, MovementType, M_Shipper_ID, NoPackages, C_Activity_ID, C_Campaign_ID, AD_OrgTrx_ID, M_FreightCategory_ID, Calculate_Freight, Freight_Currency_ID, C_Project_ID, C_Costcenter_ID, A_Asset_ID, User1_ID, User2_ID, EM_Dtpo_Linesfromcop, Delivery_Location_ID, ShipDate, IsSOTrx, RM_Receipt_PickEdit, RM_Shipment_Pickedit, DatePrinted, Processed, TrackingNo, PickDate, IsPrinted, C_Invoice_ID, GenerateLines, M_InOut_ID, Processing, IsActive, DateOrdered, UpdateLines, AD_Client_ID, Islogistic, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), TO_DATE(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), TO_TIMESTAMP(?, ?), (?), (?), (?), TO_DATE(?), (?), (?), TO_TIMESTAMP(?, ?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), now(), ?, now(), ?)";
