...
Create a registry
 */
  public static ReconciliationsFF8080813320657F0133209DE21B0042Data[] set(String finFinancialAccountId, String widget, String emAprmProcessRecForce, String emAprmProcessRecForceBtn, String emAprmPrintdetailed, String finReconciliationId, String adClientId, String adOrgId, String createdby, String createdbyr, String updatedby, String updatedbyr, String isactive, String documentno, String cDoctypeId, String dateto, String statementdate, String endingbalance, String startingbalance, String docstatus, String processing, String processed, String posted, String postedBtn, String printdetailed, String printsummary, String emAprmPrintsummary, String emAprmProcessRec, String emAprmProcessRecBtn, String emAprmProcessReconciliation)    throws ServletException {
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Isactive = (?) , FIN_Financial_Account_ID = (?) , DocumentNo = (?) , C_Doctype_ID = (?) , Widget = (?) , Dateto = TO_DATE(?) , Statementdate = TO_DATE(?) , EM_APRM_PrintDetailed = (?) , Printdetailed = (?) , Startingbalance = TO_NUMBER(?) , EM_APRM_PrintSummary = (?) , Printsummary = (?) , Endingbalance = TO_NUMBER(?) , Docstatus = (?) , Processing = (?) , Processed = (?) , Posted = (?) , EM_APRM_Process_Reconciliation = (?) , EM_Aprm_Process_Rec = (?) , EM_APRM_Process_Rec_Force = (?) , FIN_Reconciliation_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE FIN_Reconciliation.FIN_Reconciliation_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Isactive, FIN_Financial_Account_ID, DocumentNo, C_Doctype_ID, Widget, Dateto, Statementdate, EM_APRM_PrintDetailed, Printdetailed, Startingbalance, EM_APRM_PrintSummary, Printsummary, Endingbalance, Docstatus, Processing, Processed, Posted, EM_APRM_Process_Reconciliation, EM_Aprm_Process_Rec, EM_APRM_Process_Rec_Force, FIN_Reconciliation_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
