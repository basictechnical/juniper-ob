...
static Logger log4j = Logger.getLogger(ProductCategoryData.class);
  ...
  public String emEpbSubtasksIdr;
  public String emEpbItemramgeCode;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_epb_subtasks_idr") || fieldName.equals("emEpbSubtasksIdr"))
      return emEpbSubtasksIdr;
    else if (fieldName.equalsIgnoreCase("em_epb_itemramge_code") || fieldName.equals("emEpbItemramgeCode"))
      return emEpbItemramgeCode;
 ...
 */
  public static ProductCategoryData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_Product_Category.EM_Epb_Subtasks_ID, " +
      "(CASE WHEN M_Product_Category.EM_Epb_Subtasks_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table2.Name), ''))),'') ) END) AS EM_Epb_Subtasks_IDR, " +
      "M_Product_Category.EM_Epb_Itemramge_Code, " +
      "M_Product_Category.M_Product_Category_ID, " +
      "M_Product_Category.AD_Client_ID, " +
      "        ? AS LANGUAGE " +
      "        FROM M_Product_Category left join (select AD_Org_ID, Name from AD_Org) table1 on (M_Product_Category.AD_Org_ID = table1.AD_Org_ID) left join (select EPB_Subtasks_ID, Name from EPB_Subtasks) table2 on (M_Product_Category.EM_Epb_Subtasks_ID =  table2.EPB_Subtasks_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductCategoryData.emEpbSubtasksId = UtilSql.getValue(result, "em_epb_subtasks_id");
        objectProductCategoryData.emEpbSubtasksIdr = UtilSql.getValue(result, "em_epb_subtasks_idr");
        objectProductCategoryData.emEpbItemramgeCode = UtilSql.getValue(result, "em_epb_itemramge_code");
...
Create a registry
 */
  public static ProductCategoryData[] set(String emEpbItemramgeCode, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String name, String description, String mProductCategoryId, String value, String emEpbSubtasksId, String isdefault, String plannedmargin, String aAssetGroupId, String issummary, String adImageId)    throws ServletException {
    ...
    objectProductCategoryData[0].emEpbSubtasksId = emEpbSubtasksId;
    objectProductCategoryData[0].emEpbSubtasksIdr = "";
    objectProductCategoryData[0].emEpbItemramgeCode = emEpbItemramgeCode;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Value = (?) , Name = (?) , Description = (?) , IsDefault = (?) , IsActive = (?) , Issummary = (?) , PlannedMargin = TO_NUMBER(?) , AD_Image_ID = (?) , A_Asset_Group_ID = (?) , EM_Epb_Subtasks_ID = (?) , EM_Epb_Itemramge_Code = (?) , M_Product_Category_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emEpbItemramgeCode);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Value, Name, Description, IsDefault, IsActive, Issummary, PlannedMargin, AD_Image_ID, A_Asset_Group_ID, EM_Epb_Subtasks_ID, EM_Epb_Itemramge_Code, M_Product_Category_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
