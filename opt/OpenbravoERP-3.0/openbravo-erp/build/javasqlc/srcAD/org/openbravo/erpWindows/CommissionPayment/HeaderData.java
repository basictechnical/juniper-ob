 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , C_Commission_ID = (?) , DocumentNo = (?) , Description = (?) , StartDate = TO_DATE(?) , GrandTotal = TO_NUMBER(?) , Processing = (?) , C_Invoice_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , Processed = (?) , C_CommissionRun_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_Commission_ID, DocumentNo, Description, StartDate, GrandTotal, Processing, C_Invoice_ID, IsActive, AD_Client_ID, Processed, C_CommissionRun_ID, created, createdby, updated, updatedBy)" +
