...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String emDtService;
  public String emDtWork;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_dt_service") || fieldName.equals("emDtService"))
      return emDtService;
    else if (fieldName.equalsIgnoreCase("em_dt_work") || fieldName.equals("emDtWork"))
      return emDtWork;
 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_Requisition.EM_DT_Project_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Value), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table6.Name), ''))),'') ) END) AS EM_DT_Project_IDR, " +
      "M_Requisition.EM_Dt_Service, " +
      "M_Requisition.EM_Dt_Work, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.emDtProjectId = UtilSql.getValue(result, "em_dt_project_id");
        objectHeaderData.emDtProjectIdr = UtilSql.getValue(result, "em_dt_project_idr");
        objectHeaderData.emDtService = UtilSql.getValue(result, "em_dt_service");
        objectHeaderData.emDtWork = UtilSql.getValue(result, "em_dt_work");
 ...
 */
  public static HeaderData[] set(String createpo, String docstatus, String docaction, String docactionBtn, String processed, String adUserId, String processing, String emEpbMainsectionId, String mRequisitionId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String description, String documentno, String cBpartnerId, String cBpartnerIdr, String mPricelistId, String cCurrencyId, String emDtProjectId, String emDtProjectIdr, String emDtService, String emEpbSubtasksId, String emEpbSubsectionId, String emDtWork)    throws ServletException {
    ...
    objectHeaderData[0].emDtProjectId = emDtProjectId;
    objectHeaderData[0].emDtProjectIdr = emDtProjectIdr;
    objectHeaderData[0].emDtService = emDtService;
    objectHeaderData[0].emDtWork = emDtWork;
...
Select for auxiliar field
 */
  public static String selectActP8D397291161B4278BF176601BD6C8AB0_C_BPartner_ID(ConnectionProvider connectionProvider, String M_Requisition_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT M_Requisition.C_Bpartner_Id FROM M_Requisition, (SELECT count(*) as SameBP FROM M_Requisition inner join M_requisitionLine ON M_Requisition.M_Requisition_id = M_requisitionLine.M_Requisition_id WHERE M_Requisition.c_bpartner_id = M_requisitionLine.c_bpartner_id AND M_Requisition.M_Requisition_id = ?) SameBP,  (SELECT count(*) as QtyLines FROM M_RequisitionLine WHERE M_RequisitionLine.M_Requisition_id=?) QtyLines  WHERE SameBP.SameBP = QtyLines.QtyLines AND M_Requisition.M_Requisition_id =? ";
...
Select for auxiliar field
 */
  public static String selectActP8D397291161B4278BF176601BD6C8AB0_M_PriceList_ID(ConnectionProvider connectionProvider, String M_Requisition_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT M_Requisition.m_pricelist_id  FROM M_Requisition,       (SELECT count(*) as SamePL        FROM M_Requisition inner join M_requisitionLine ON M_Requisition.M_Requisition_id = M_requisitionLine.M_Requisition_id       WHERE M_Requisition.m_pricelist_id = M_requisitionLine.m_pricelist_id AND M_Requisition.M_Requisition_id = ?) SamePL,        (SELECT count(*) as QtyLines       FROM M_RequisitionLine       WHERE M_RequisitionLine.M_Requisition_id=?) QtyLines   WHERE SamePL.SamePL = QtyLines.QtyLines AND M_Requisition.M_Requisition_id =? ";
...
Select for auxiliar field
 */
  public static String selectActPCC39852BA9A2403586BAB26B11C8A5AE_M_PriceList_ID(ConnectionProvider connectionProvider, String M_Requisition_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT M_Requisition.m_pricelist_id  FROM M_Requisition,       (SELECT count(*) as SamePL        FROM M_Requisition inner join M_requisitionLine ON M_Requisition.M_Requisition_id = M_requisitionLine.M_Requisition_id       WHERE M_Requisition.m_pricelist_id = M_requisitionLine.m_pricelist_id AND M_Requisition.M_Requisition_id = ?) SamePL,        (SELECT count(*) as QtyLines       FROM M_RequisitionLine       WHERE M_RequisitionLine.M_Requisition_id=?) QtyLines   WHERE SamePL.SamePL = QtyLines.QtyLines AND M_Requisition.M_Requisition_id =? ";
...
Select for auxiliar field
 */
  public static String selectActPCC39852BA9A2403586BAB26B11C8A5AE_C_BPartner_ID(ConnectionProvider connectionProvider, String M_Requisition_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT M_Requisition.C_Bpartner_Id FROM M_Requisition, (SELECT count(*) as SameBP FROM M_Requisition inner join M_requisitionLine ON M_Requisition.M_Requisition_id = M_requisitionLine.M_Requisition_id WHERE M_Requisition.c_bpartner_id = M_requisitionLine.c_bpartner_id AND M_Requisition.M_Requisition_id = ?) SameBP,  (SELECT count(*) as QtyLines FROM M_RequisitionLine WHERE M_RequisitionLine.M_Requisition_id=?) QtyLines  WHERE SameBP.SameBP = QtyLines.QtyLines AND M_Requisition.M_Requisition_id =? ";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_Requisition" +
      "        SET AD_Org_ID = (?) , DocumentNo = (?) , Description = (?) , C_BPartner_ID = (?) , AD_User_ID = (?) , M_PriceList_ID = (?) , C_Currency_ID = (?) , Createpo = (?) , DocStatus = (?) , DocAction = (?) , EM_DT_Project_ID = (?) , EM_Dt_Service = (?) , EM_Dt_Work = (?) , EM_Epb_Mainsection_ID = (?) , EM_Epb_Subsection_ID = (?) , EM_Epb_Subtasks_ID = (?) , AD_Client_ID = (?) , IsActive = (?) , Processed = (?) , M_Requisition_ID = (?) , Processing = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_Requisition.M_Requisition_ID = ? " +
      "        AND M_Requisition.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtService);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtWork);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, DocumentNo, Description, C_BPartner_ID, AD_User_ID, M_PriceList_ID, C_Currency_ID, Createpo, DocStatus, DocAction, EM_DT_Project_ID, EM_Dt_Service, EM_Dt_Work, EM_Epb_Mainsection_ID, EM_Epb_Subsection_ID, EM_Epb_Subtasks_ID, AD_Client_ID, IsActive, Processed, M_Requisition_ID, Processing, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
