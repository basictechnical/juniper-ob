...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String emPcCreatelines;
  public String emEpbSubsectionId;
  public String createPolines;
  public String emEpbSubtasksId;
  public String emDtpoAdvance;
  public String emDtpoAdvamt;
  public String emDtpoPaymentdesc;
  public String emDtpoSynpoamt;
  public String emDtpoCTaxId;
  public String emDtpoCTaxIdr;
  public String emDtpoOrderscenario;
  public String emDtpoOrderscenarior;
  public String emDtpoAmmendment;
  public String emDtpoInactive;
  public String emDtpoCurrency;
  public String emDtpoConversionrate;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_pc_createlines") || fieldName.equals("emPcCreatelines"))
      return emPcCreatelines;
    ...
    else if (fieldName.equalsIgnoreCase("em_dtpo_advance") || fieldName.equals("emDtpoAdvance"))
      return emDtpoAdvance;
    else if (fieldName.equalsIgnoreCase("em_dtpo_advamt") || fieldName.equals("emDtpoAdvamt"))
      return emDtpoAdvamt;
    else if (fieldName.equalsIgnoreCase("em_dtpo_paymentdesc") || fieldName.equals("emDtpoPaymentdesc"))
      return emDtpoPaymentdesc;
    else if (fieldName.equalsIgnoreCase("em_dtpo_synpoamt") || fieldName.equals("emDtpoSynpoamt"))
      return emDtpoSynpoamt;
    else if (fieldName.equalsIgnoreCase("em_dtpo_c_tax_id") || fieldName.equals("emDtpoCTaxId"))
      return emDtpoCTaxId;
    else if (fieldName.equalsIgnoreCase("em_dtpo_c_tax_idr") || fieldName.equals("emDtpoCTaxIdr"))
      return emDtpoCTaxIdr;
    else if (fieldName.equalsIgnoreCase("em_dtpo_orderscenario") || fieldName.equals("emDtpoOrderscenario"))
      return emDtpoOrderscenario;
    else if (fieldName.equalsIgnoreCase("em_dtpo_orderscenarior") || fieldName.equals("emDtpoOrderscenarior"))
      return emDtpoOrderscenarior;
    else if (fieldName.equalsIgnoreCase("em_dtpo_ammendment") || fieldName.equals("emDtpoAmmendment"))
      return emDtpoAmmendment;
    else if (fieldName.equalsIgnoreCase("em_dtpo_inactive") || fieldName.equals("emDtpoInactive"))
      return emDtpoInactive;
    else if (fieldName.equalsIgnoreCase("em_dtpo_currency") || fieldName.equals("emDtpoCurrency"))
      return emDtpoCurrency;
    else if (fieldName.equalsIgnoreCase("em_dtpo_conversionrate") || fieldName.equals("emDtpoConversionrate"))
      return emDtpoConversionrate;
 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "C_Order.User1_ID, " +
      "C_Order.User2_ID, " +
      "C_Order.EM_Epb_Mainsection_ID, " +
      "C_Order.EM_Pc_Createlines, " +
      "C_Order.EM_Epb_Subsection_ID, " +
      "C_Order.Create_POLines, " +
      "C_Order.EM_Epb_Subtasks_ID, " +
      "COALESCE(C_Order.EM_Dtpo_Advance, 'N') AS EM_Dtpo_Advance, " +
      "C_Order.EM_Dtpo_Advamt, " +
      "C_Order.EM_Dtpo_Paymentdesc, " +
      "C_Order.EM_Dtpo_Synpoamt, " +
      "C_Order.EM_Dtpo_C_Tax_ID, " +
      "(CASE WHEN C_Order.EM_Dtpo_C_Tax_ID IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL11.Name IS NULL THEN TO_CHAR(table11.Name) ELSE TO_CHAR(tableTRL11.Name) END)), ''))),'') ) END) AS EM_Dtpo_C_Tax_IDR, " +
      "C_Order.EM_Dtpo_Orderscenario, " +
      "(CASE WHEN C_Order.EM_Dtpo_Orderscenario IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(list2.name),'') ) END) AS EM_Dtpo_OrderscenarioR, " +
      "C_Order.EM_Dtpo_Ammendment, " +
      "COALESCE(C_Order.EM_Dtpo_Inactive, 'N') AS EM_Dtpo_Inactive, " +
      "C_Order.EM_Dtpo_Currency, " +
      "C_Order.EM_Dtpo_Conversionrate, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.emEpbMainsectionId = UtilSql.getValue(result, "em_epb_mainsection_id");
        objectHeaderData.emPcCreatelines = UtilSql.getValue(result, "em_pc_createlines");
        objectHeaderData.emEpbSubsectionId = UtilSql.getValue(result, "em_epb_subsection_id");
        objectHeaderData.createPolines = UtilSql.getValue(result, "create_polines");
        objectHeaderData.emEpbSubtasksId = UtilSql.getValue(result, "em_epb_subtasks_id");
        objectHeaderData.emDtpoAdvance = UtilSql.getValue(result, "em_dtpo_advance");
        objectHeaderData.emDtpoAdvamt = UtilSql.getValue(result, "em_dtpo_advamt");
        objectHeaderData.emDtpoPaymentdesc = UtilSql.getValue(result, "em_dtpo_paymentdesc");
        objectHeaderData.emDtpoSynpoamt = UtilSql.getValue(result, "em_dtpo_synpoamt");
        objectHeaderData.emDtpoCTaxId = UtilSql.getValue(result, "em_dtpo_c_tax_id");
        objectHeaderData.emDtpoCTaxIdr = UtilSql.getValue(result, "em_dtpo_c_tax_idr");
        objectHeaderData.emDtpoOrderscenario = UtilSql.getValue(result, "em_dtpo_orderscenario");
        objectHeaderData.emDtpoOrderscenarior = UtilSql.getValue(result, "em_dtpo_orderscenarior");
        objectHeaderData.emDtpoAmmendment = UtilSql.getValue(result, "em_dtpo_ammendment");
        objectHeaderData.emDtpoInactive = UtilSql.getValue(result, "em_dtpo_inactive");
        objectHeaderData.emDtpoCurrency = UtilSql.getValue(result, "em_dtpo_currency");
        objectHeaderData.emDtpoConversionrate = UtilSql.getValue(result, "em_dtpo_conversionrate");
...
Create a registry
 */
  public static HeaderData[] set(String emDtpoCurrency, String emDtpoAdvance, String convertquotation, String validuntil, String aAssetId, String cOrderId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String documentno, String docstatus, String docaction, String docactionBtn, String cDoctypeId, String cDoctypetargetId, String description, String isdelivered, String isinvoiced, String isprinted, String dateordered, String datepromised, String dateacct, String salesrepId, String cPaymenttermId, String billtoId, String cCurrencyId, String invoicerule, String freightamt, String deliveryviarule, String mShipperId, String priorityrule, String totallines, String grandtotal, String mWarehouseId, String mPricelistId, String processing, String cCampaignId, String cBpartnerId, String cBpartnerIdr, String adUserId, String poreference, String cChargeId, String chargeamt, String processed, String cBpartnerLocationId, String cProjectId, String cProjectIdr, String cActivityId, String quotationId, String quotationIdr, String issotrx, String dateprinted, String deliveryrule, String freightcostrule, String emDtpoAdvamt, String paymentrule, String isdiscountprinted, String posted, String istaxincluded, String isselected, String emDtpoAmmendment, String emDtpoCTaxId, String emDtpoSynpoamt, String cCostcenterId, String emDtpoConversionrate, String deliverynotes, String cIncotermsId, String incotermsdescription, String generatetemplate, String deliveryLocationId, String copyfrompo, String finPaymentmethodId, String emDtpoInactive, String dropshipUserId, String dropshipBpartnerId, String copyfrom, String dropshipLocationId, String isselfservice, String adOrgtrxId, String user2Id, String user1Id, String calculatePromotions, String emEpbMainsectionId, String emEpbSubsectionId, String emDtpoOrderscenario, String emEpbSubtasksId, String rmPickfromshipment, String rmReceivematerials, String rmCreateinvoice, String emPcCreatelines, String emDtpoPaymentdesc, String cReturnReasonId, String rmAddorphanline, String soResStatus, String createPolines, String cRejectReasonId)    throws ServletException {
    ...
    objectHeaderData[0].emEpbMainsectionId = emEpbMainsectionId;
    objectHeaderData[0].emPcCreatelines = emPcCreatelines;
    objectHeaderData[0].emEpbSubsectionId = emEpbSubsectionId;
    objectHeaderData[0].createPolines = createPolines;
    objectHeaderData[0].emEpbSubtasksId = emEpbSubtasksId;
    objectHeaderData[0].emDtpoAdvance = emDtpoAdvance;
    objectHeaderData[0].emDtpoAdvamt = emDtpoAdvamt;
    objectHeaderData[0].emDtpoPaymentdesc = emDtpoPaymentdesc;
    objectHeaderData[0].emDtpoSynpoamt = emDtpoSynpoamt;
    objectHeaderData[0].emDtpoCTaxId = emDtpoCTaxId;
    objectHeaderData[0].emDtpoCTaxIdr = "";
    objectHeaderData[0].emDtpoOrderscenario = emDtpoOrderscenario;
    objectHeaderData[0].emDtpoOrderscenarior = "";
    objectHeaderData[0].emDtpoAmmendment = emDtpoAmmendment;
    objectHeaderData[0].emDtpoInactive = emDtpoInactive;
    objectHeaderData[0].emDtpoCurrency = emDtpoCurrency;
    objectHeaderData[0].emDtpoConversionrate = emDtpoConversionrate;
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emPcCreatelines);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoAdvance);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoAdvamt);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoPaymentdesc);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoSynpoamt);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoCTaxId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoOrderscenario);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoAmmendment);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoInactive);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoCurrency);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emDtpoConversionrate);
