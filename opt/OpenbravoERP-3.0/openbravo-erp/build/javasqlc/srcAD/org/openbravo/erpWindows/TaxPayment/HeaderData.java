 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_TaxPayment" +
      "        SET AD_Org_ID = (?) , Name = (?) , C_BPartner_ID = (?) , C_AcctSchema_ID = (?) , C_Currency_ID = (?) , Datefrom = TO_DATE(?) , Dateto = TO_DATE(?) , GL_Journal_ID = (?) , Generatepayment = (?) , CreateFrom = (?) , Processed = (?) , C_Taxpayment_ID = (?) , Processing = (?) , C_Settlement_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Name, C_BPartner_ID, C_AcctSchema_ID, C_Currency_ID, Datefrom, Dateto, GL_Journal_ID, Generatepayment, CreateFrom, Processed, Processing, C_Taxpayment_ID, IsActive, AD_Client_ID, C_Settlement_ID, created, createdby, updated, updatedBy)" +
