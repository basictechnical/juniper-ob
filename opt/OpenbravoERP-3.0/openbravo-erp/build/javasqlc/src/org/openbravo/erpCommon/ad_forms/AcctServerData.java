...
static Logger log4j = Logger.getLogger(AcctServerData.class);
  ...
  public static AcctServerData[] select(ConnectionProvider connectionProvider, String tableName, String dateColumn, String client, String StrOrg, String dateFrom, String dateTo)    throws ServletException {
    return select(connectionProvider, tableName, dateColumn, client, StrOrg, dateFrom, dateTo, 0, 0);
  }

  public static AcctServerData[] select(ConnectionProvider connectionProvider, String tableName, String dateColumn, String client, String StrOrg, String dateFrom, String dateTo, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "	      Select * from(" +
      "        SELECT  a.";
