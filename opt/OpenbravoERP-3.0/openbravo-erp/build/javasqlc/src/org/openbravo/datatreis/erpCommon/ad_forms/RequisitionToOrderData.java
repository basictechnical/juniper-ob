...
package org.openbravo.datatreis.erpCommon.ad_forms;
...
static Logger log4j = Logger.getLogger(RequisitionToOrderData.class);
  ...
  public static RequisitionToOrderData[] select(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "          '' as GROSS_UNIT, '' AS GROSS_AMT,'' AS PROJECT" +
      "        FROM DUAL";
  ...
  public static RequisitionToOrderData[] selectLines(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgId, String parDateFrom, String parDateTo, String parProduct, String parRequester, String parVendorInc, String parVendor, String parProject)    throws ServletException {
    return selectLines(connectionProvider, language, adUserClient, adOrgId, parDateFrom, parDateTo, parProduct, parRequester, parVendorInc, parVendor, parProject, 0, 0);
  }

  public static RequisitionToOrderData[] selectLines(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgId, String parDateFrom, String parDateTo, String parProduct, String parRequester, String parVendorInc, String parVendor, String parProject, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    strSql = strSql + ((parProject==null || parProject.equals(""))?"":"  AND M_REQUISITION.em_dt_project_id = TO_CHAR(?) ");
    strSql = strSql + 
