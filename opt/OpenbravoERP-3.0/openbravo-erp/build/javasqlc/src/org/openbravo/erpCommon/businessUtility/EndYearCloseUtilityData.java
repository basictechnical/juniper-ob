 ...
 */
  ...
  public static boolean selectYearNotClosed(ConnectionProvider connectionProvider, String cYearId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select 1 " +
  ...
  public static boolean selectUndoAllowed(ConnectionProvider connectionProvider, String cYearId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "    select 1 from dual" +
