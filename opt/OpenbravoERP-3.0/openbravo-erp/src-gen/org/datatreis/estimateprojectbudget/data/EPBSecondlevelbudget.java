...
/**
 * Entity class for entity EPB_Secondlevelbudget (stored in table EPB_Secondlevelbudget).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EPBSecondlevelbudget extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "EPB_Secondlevelbudget";
    public static final String ENTITY_NAME = "EPB_Secondlevelbudget";
    ...
    public String getBudgetAmt() {
        return (String) get(PROPERTY_BUDGETAMT);
    }
