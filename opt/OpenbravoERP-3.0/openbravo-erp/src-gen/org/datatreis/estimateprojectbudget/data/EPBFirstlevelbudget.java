...
/**
 * Entity class for entity EPB_Firstlevelbudget (stored in table EPB_Firstlevelbudget).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EPBFirstlevelbudget extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "EPB_Firstlevelbudget";
    public static final String ENTITY_NAME = "EPB_Firstlevelbudget";
    ...
    public static final String PROPERTY_MAINSECTION = "mainSection";
    ...
    public EPBMainsection getMainSection() {
        return (EPBMainsection) get(PROPERTY_MAINSECTION);
    }

    public void setMainSection(EPBMainsection mainSection) {
        set(PROPERTY_MAINSECTION, mainSection);
    }
