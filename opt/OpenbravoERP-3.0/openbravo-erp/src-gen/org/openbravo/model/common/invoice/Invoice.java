...
public class Invoice extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_DTTAXNAME = "dtTaxname";
    public static final String PROPERTY_DTIRNNO = "dtIrnno";
    public static final String PROPERTY_CASHVAT = "cashVAT";
    public static final String PROPERTY_DTPOLICYNO = "dtPolicyno";
    public static final String PROPERTY_DTEXCISECHALAN = "dtExcisechalan";
    ...
    public String getDtTaxname() {
        return (String) get(PROPERTY_DTTAXNAME);
    }

    public void setDtTaxname(String dtTaxname) {
        set(PROPERTY_DTTAXNAME, dtTaxname);
    }

    public String getDtIrnno() {
        return (String) get(PROPERTY_DTIRNNO);
    }

    public void setDtIrnno(String dtIrnno) {
        set(PROPERTY_DTIRNNO, dtIrnno);
    }
    ...
    public String getDtPolicyno() {
        return (String) get(PROPERTY_DTPOLICYNO);
    }

    public void setDtPolicyno(String dtPolicyno) {
        set(PROPERTY_DTPOLICYNO, dtPolicyno);
    }

    public String getDtExcisechalan() {
        return (String) get(PROPERTY_DTEXCISECHALAN);
    }

    public void setDtExcisechalan(String dtExcisechalan) {
        set(PROPERTY_DTEXCISECHALAN, dtExcisechalan);
    }
