...
public class ProductCategory extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_EPBITEMRAMGECODE = "epbItemramgeCode";
    ...
    public String getEpbItemramgeCode() {
        return (String) get(PROPERTY_EPBITEMRAMGECODE);
    }

    public void setEpbItemramgeCode(String epbItemramgeCode) {
        set(PROPERTY_EPBITEMRAMGECODE, epbItemramgeCode);
    }
