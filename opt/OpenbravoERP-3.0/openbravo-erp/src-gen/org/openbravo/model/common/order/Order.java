...
import org.datatreis.estimateprojectbudget.data.EPBMainsection;
import org.datatreis.estimateprojectbudget.data.EPBSubsection;
import org.datatreis.estimateprojectbudget.data.EPBSubtasks;
...
import org.openbravo.datatreis.data.OrderTC;
...
public class Order extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_DTAMMENDMENT = "dtAmmendment";
    public static final String PROPERTY_CALCULATEPROMOTIONS = "calculatePromotions";
    public static final String PROPERTY_DTPLAINDOCNO = "dtPlaindocno";
    public static final String PROPERTY_COSTCENTER = "costcenter";
    public static final String PROPERTY_CREATEORDER = "createOrder";
    public static final String PROPERTY_DTVENDORCODE = "dtVendorcode";
    ...
    public static final String PROPERTY_EPBMAINSECTION = "epbMainsection";
    public static final String PROPERTY_EPBSUBSECTION = "epbSubsection";
    public static final String PROPERTY_EPBSUBTASKS = "epbSubtasks";
    public static final String PROPERTY_DTPOADVANCE = "dtpoAdvance";
    public static final String PROPERTY_DTPOADVAMT = "dtpoAdvamt";
    public static final String PROPERTY_DTPOPAYMENTDESC = "dtpoPaymentdesc";
    public static final String PROPERTY_DTPOSYNPOAMT = "dtpoSynpoamt";
    public static final String PROPERTY_DTPOCTAX = "dtpoCTax";
    public static final String PROPERTY_DTPOORDERSCENARIO = "dtpoOrderscenario";
    public static final String PROPERTY_DTPOAMMENDMENT = "dtpoAmmendment";
    public static final String PROPERTY_PCCREATELINES = "pcCreatelines";
    public static final String PROPERTY_DTPOINACTIVE = "dtpoInactive";
    public static final String PROPERTY_DTPOCURRENCY = "dtpoCurrency";
    public static final String PROPERTY_DTPOCONVERSIONRATE = "dtpoConversionrate";
    public static final String PROPERTY__COMPUTEDCOLUMNS = "_computedColumns";
    public static final String PROPERTY_DTPOPOCOPFILELIST = "dTPOPocopfileList";
    public static final String PROPERTY_ORDERTCLIST = "orderTCList";
    ...
    public Order() {
        ...
        setDefaultValue(PROPERTY_DTAMMENDMENT, (long) 0);
        ...
        setDefaultValue(PROPERTY_DTPOADVANCE, false);
        setDefaultValue(PROPERTY_DTPOSYNPOAMT, false);
        setDefaultValue(PROPERTY_DTPOAMMENDMENT, false);
        setDefaultValue(PROPERTY_PCCREATELINES, false);
        setDefaultValue(PROPERTY_DTPOINACTIVE, false);
        setDefaultValue(PROPERTY_DTPOPOCOPFILELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ORDERTCLIST, new ArrayList<Object>());
    ...
    public Long getDtAmmendment() {
        return (Long) get(PROPERTY_DTAMMENDMENT);
    }

    public void setDtAmmendment(Long dtAmmendment) {
        set(PROPERTY_DTAMMENDMENT, dtAmmendment);
    }
    ...
    public String getDtPlaindocno() {
        return (String) get(PROPERTY_DTPLAINDOCNO);
    }

    public void setDtPlaindocno(String dtPlaindocno) {
        set(PROPERTY_DTPLAINDOCNO, dtPlaindocno);
    }
    ...
    public String getDtVendorcode() {
        return (String) get(PROPERTY_DTVENDORCODE);
    }

    public void setDtVendorcode(String dtVendorcode) {
        set(PROPERTY_DTVENDORCODE, dtVendorcode);
    }
    ...
    public EPBMainsection getEpbMainsection() {
        return (EPBMainsection) get(PROPERTY_EPBMAINSECTION);
    }

    public void setEpbMainsection(EPBMainsection epbMainsection) {
        set(PROPERTY_EPBMAINSECTION, epbMainsection);
    }

    public EPBSubsection getEpbSubsection() {
        return (EPBSubsection) get(PROPERTY_EPBSUBSECTION);
    }

    public void setEpbSubsection(EPBSubsection epbSubsection) {
        set(PROPERTY_EPBSUBSECTION, epbSubsection);
    }
    ...
    public Boolean isDtpoAdvance() {
        return (Boolean) get(PROPERTY_DTPOADVANCE);
    }

    public void setDtpoAdvance(Boolean dtpoAdvance) {
        set(PROPERTY_DTPOADVANCE, dtpoAdvance);
    }

    public Long getDtpoAdvamt() {
        return (Long) get(PROPERTY_DTPOADVAMT);
    }

    public void setDtpoAdvamt(Long dtpoAdvamt) {
        set(PROPERTY_DTPOADVAMT, dtpoAdvamt);
    }

    public String getDtpoPaymentdesc() {
        return (String) get(PROPERTY_DTPOPAYMENTDESC);
    }

    public void setDtpoPaymentdesc(String dtpoPaymentdesc) {
        set(PROPERTY_DTPOPAYMENTDESC, dtpoPaymentdesc);
    }

    public Boolean isDtpoSynpoamt() {
        return (Boolean) get(PROPERTY_DTPOSYNPOAMT);
    }

    public void setDtpoSynpoamt(Boolean dtpoSynpoamt) {
        set(PROPERTY_DTPOSYNPOAMT, dtpoSynpoamt);
    }

    public TaxRate getDtpoCTax() {
        return (TaxRate) get(PROPERTY_DTPOCTAX);
    }

    public void setDtpoCTax(TaxRate dtpoCTax) {
        set(PROPERTY_DTPOCTAX, dtpoCTax);
    }

    public String getDtpoOrderscenario() {
        return (String) get(PROPERTY_DTPOORDERSCENARIO);
    }

    public void setDtpoOrderscenario(String dtpoOrderscenario) {
        set(PROPERTY_DTPOORDERSCENARIO, dtpoOrderscenario);
    }

    public Boolean isDtpoAmmendment() {
        return (Boolean) get(PROPERTY_DTPOAMMENDMENT);
    }

    public void setDtpoAmmendment(Boolean dtpoAmmendment) {
        set(PROPERTY_DTPOAMMENDMENT, dtpoAmmendment);
    }

    public Boolean isPcCreatelines() {
        return (Boolean) get(PROPERTY_PCCREATELINES);
    }

    public void setPcCreatelines(Boolean pcCreatelines) {
        set(PROPERTY_PCCREATELINES, pcCreatelines);
    }

    public Boolean isDtpoInactive() {
        return (Boolean) get(PROPERTY_DTPOINACTIVE);
    }

    public void setDtpoInactive(Boolean dtpoInactive) {
        set(PROPERTY_DTPOINACTIVE, dtpoInactive);
    }

    public String getDtpoCurrency() {
        return (String) get(PROPERTY_DTPOCURRENCY);
    }

    public void setDtpoCurrency(String dtpoCurrency) {
        set(PROPERTY_DTPOCURRENCY, dtpoCurrency);
    }

    public BigDecimal getDtpoConversionrate() {
        return (BigDecimal) get(PROPERTY_DTPOCONVERSIONRATE);
    }

    public void setDtpoConversionrate(BigDecimal dtpoConversionrate) {
        set(PROPERTY_DTPOCONVERSIONRATE, dtpoConversionrate);
    }
    ...
    public List<DTPOPocopfile> getDTPOPocopfileList() {
      return (List<DTPOPocopfile>) get(PROPERTY_DTPOPOCOPFILELIST);
    }

    public void setDTPOPocopfileList(List<DTPOPocopfile> dTPOPocopfileList) {
        set(PROPERTY_DTPOPOCOPFILELIST, dTPOPocopfileList);
    }

    @SuppressWarnings("unchecked")
    public List<OrderTC> getOrderTCList() {
      return (List<OrderTC>) get(PROPERTY_ORDERTCLIST);
    }

    public void setOrderTCList(List<OrderTC> orderTCList) {
        set(PROPERTY_ORDERTCLIST, orderTCList);
    }
