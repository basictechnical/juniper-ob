...
public class BusinessPartner extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP1LIST = "procurementRequisitionLineEMDTBp1List";
    public static final String PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP2LIST = "procurementRequisitionLineEMDTBp2List";
    public static final String PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP3LIST = "procurementRequisitionLineEMDTBp3List";
    ...
    public BusinessPartner() {
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP1LIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP2LIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP3LIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<RequisitionLine> getProcurementRequisitionLineEMDTBp1List() {
      return (List<RequisitionLine>) get(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP1LIST);
    }

    public void setProcurementRequisitionLineEMDTBp1List(List<RequisitionLine> procurementRequisitionLineEMDTBp1List) {
        set(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP1LIST, procurementRequisitionLineEMDTBp1List);
    }

    @SuppressWarnings("unchecked")
    public List<RequisitionLine> getProcurementRequisitionLineEMDTBp2List() {
      return (List<RequisitionLine>) get(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP2LIST);
    }

    public void setProcurementRequisitionLineEMDTBp2List(List<RequisitionLine> procurementRequisitionLineEMDTBp2List) {
        set(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP2LIST, procurementRequisitionLineEMDTBp2List);
    }

    @SuppressWarnings("unchecked")
    public List<RequisitionLine> getProcurementRequisitionLineEMDTBp3List() {
      return (List<RequisitionLine>) get(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP3LIST);
    }

    public void setProcurementRequisitionLineEMDTBp3List(List<RequisitionLine> procurementRequisitionLineEMDTBp3List) {
        set(PROPERTY_PROCUREMENTREQUISITIONLINEEMDTBP3LIST, procurementRequisitionLineEMDTBp3List);
    }
