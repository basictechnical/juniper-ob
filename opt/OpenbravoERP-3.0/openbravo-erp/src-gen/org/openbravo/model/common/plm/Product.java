...
public class Product extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_IDLJAVADESC = "idljavaDesc";
    public static final String PROPERTY_DTZKMAKE = "dtzkMake";
    public static final String PROPERTY_ISGENERIC = "isGeneric";
    public static final String PROPERTY_UOMFORWEIGHT = "uOMForWeight";
    public static final String PROPERTY_DTZKMODEL = "dtzkModel";
    ...
    public static final String PROPERTY_DTZKHSNCODE = "dtzkHsncode";
    public static final String PROPERTY_CHARACTERISTICDESCRIPTION = "characteristicDescription";
    public static final String PROPERTY_DTZKCOUNTRYORIGIN = "dtzkCountryorigin";
    public static final String PROPERTY_DTZKPORTLOADING = "dtzkPortloading";
    ...
    public String getIdljavaDesc() {
        return (String) get(PROPERTY_IDLJAVADESC);
    }

    public void setIdljavaDesc(String idljavaDesc) {
        set(PROPERTY_IDLJAVADESC, idljavaDesc);
    }

    public String getDtzkMake() {
        return (String) get(PROPERTY_DTZKMAKE);
    }

    public void setDtzkMake(String dtzkMake) {
        set(PROPERTY_DTZKMAKE, dtzkMake);
    }
    ...
    public String getDtzkModel() {
        return (String) get(PROPERTY_DTZKMODEL);
    }

    public void setDtzkModel(String dtzkModel) {
        set(PROPERTY_DTZKMODEL, dtzkModel);
    }
    ...
    public String getDtzkHsncode() {
        return (String) get(PROPERTY_DTZKHSNCODE);
    }

    public void setDtzkHsncode(String dtzkHsncode) {
        set(PROPERTY_DTZKHSNCODE, dtzkHsncode);
    }
    ...
    public String getDtzkCountryorigin() {
        return (String) get(PROPERTY_DTZKCOUNTRYORIGIN);
    }

    public void setDtzkCountryorigin(String dtzkCountryorigin) {
        set(PROPERTY_DTZKCOUNTRYORIGIN, dtzkCountryorigin);
    }

    public String getDtzkPortloading() {
        return (String) get(PROPERTY_DTZKPORTLOADING);
    }

    public void setDtzkPortloading(String dtzkPortloading) {
        set(PROPERTY_DTZKPORTLOADING, dtzkPortloading);
    }
