...
public class RequisitionLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PCPENDINGQTY = "pcPendingqty";
    public static final String PROPERTY_GROSSAMOUNT = "grossAmount";
    public static final String PROPERTY_DTBP1 = "dTBp1";
    public static final String PROPERTY_PCCHECK = "pcCheck";
    public static final String PROPERTY_DTBP2 = "dTBp2";
    public static final String PROPERTY_DTBP3 = "dTBp3";
    ...
    public static final String PROPERTY_ORDERLINEEMPCREQUISITIONLINEIDLIST = "orderLineEMPcRequisitionlineIDList";
    ...
    public RequisitionLine() {
        ...
        setDefaultValue(PROPERTY_PCPENDINGQTY, (long) 0);
        setDefaultValue(PROPERTY_GROSSAMOUNT, new BigDecimal(0));
        setDefaultValue(PROPERTY_PCCHECK, false);
        ...
        setDefaultValue(PROPERTY_ORDERLINEEMPCREQUISITIONLINEIDLIST, new ArrayList<Object>());
    ...
    public Long getPcPendingqty() {
        return (Long) get(PROPERTY_PCPENDINGQTY);
    }

    public void setPcPendingqty(Long pcPendingqty) {
        set(PROPERTY_PCPENDINGQTY, pcPendingqty);
    }
    ...
    public BusinessPartner getDTBp1() {
        return (BusinessPartner) get(PROPERTY_DTBP1);
    }

    public void setDTBp1(BusinessPartner dTBp1) {
        set(PROPERTY_DTBP1, dTBp1);
    }

    public Boolean isPcCheck() {
        return (Boolean) get(PROPERTY_PCCHECK);
    }

    public void setPcCheck(Boolean pcCheck) {
        set(PROPERTY_PCCHECK, pcCheck);
    }

    public BusinessPartner getDTBp2() {
        return (BusinessPartner) get(PROPERTY_DTBP2);
    }

    public void setDTBp2(BusinessPartner dTBp2) {
        set(PROPERTY_DTBP2, dTBp2);
    }

    public BusinessPartner getDTBp3() {
        return (BusinessPartner) get(PROPERTY_DTBP3);
    }

    public void setDTBp3(BusinessPartner dTBp3) {
        set(PROPERTY_DTBP3, dTBp3);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OrderLine> getOrderLineEMPcRequisitionlineIDList() {
      return (List<OrderLine>) get(PROPERTY_ORDERLINEEMPCREQUISITIONLINEIDLIST);
    }

    public void setOrderLineEMPcRequisitionlineIDList(List<OrderLine> orderLineEMPcRequisitionlineIDList) {
        set(PROPERTY_ORDERLINEEMPCREQUISITIONLINEIDLIST, orderLineEMPcRequisitionlineIDList);
    }
