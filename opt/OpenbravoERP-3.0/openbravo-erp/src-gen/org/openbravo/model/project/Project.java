...
import org.datatreis.estimateprojectbudget.data.EPBFirstlevelbudget;
import org.datatreis.estimateprojectbudget.data.EPBFourthlevelbgt;
import org.datatreis.estimateprojectbudget.data.EPBMainsection;
import org.datatreis.estimateprojectbudget.data.EPBSecondlevelbudget;
import org.datatreis.estimateprojectbudget.data.EPBThirdlevelbudget;
...
public class Project extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_DTZKASSOCIATEPB = "dtzkAssociatepb";
    public static final String PROPERTY_DTZKASSOCIATECOSTBUDGET = "dtzkAssociatecostbudget";
    public static final String PROPERTY_DTZKFILENAME = "dtzkFilename";
    public static final String PROPERTY_DTZKCOSTBUDGETVIEW = "dtzkCostbudgetview";
    ...
    public static final String PROPERTY_EPBFIRSTLEVELBUDGETLIST = "ePBFirstlevelbudgetList";
    public static final String PROPERTY_EPBFOURTHLEVELBGTLIST = "ePBFourthlevelbgtList";
    public static final String PROPERTY_EPBMAINSECTIONLIST = "ePBMainsectionList";
    public static final String PROPERTY_EPBSECONDLEVELBUDGETLIST = "ePBSecondlevelbudgetList";
    public static final String PROPERTY_EPBTHIRDLEVELBUDGETLIST = "ePBThirdlevelbudgetList";
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONEMDTPROJECTIDLIST = "procurementRequisitionEMDTProjectIDList";
    public static final String PROPERTY_PROCUREMENTREQUISITIONEMPCPROJECTIDLIST = "procurementRequisitionEMPcProjectIDList";
    ...
    public Project() {
        ...
        setDefaultValue(PROPERTY_DTZKASSOCIATEPB, "www.google.com");
        setDefaultValue(PROPERTY_DTZKASSOCIATECOSTBUDGET, false);
        ...
        setDefaultValue(PROPERTY_EPBFIRSTLEVELBUDGETLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_EPBFOURTHLEVELBGTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_EPBMAINSECTIONLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_EPBSECONDLEVELBUDGETLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_EPBTHIRDLEVELBUDGETLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONEMDTPROJECTIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONEMPCPROJECTIDLIST, new ArrayList<Object>());
    ...
    public String getDtzkAssociatepb() {
        return (String) get(PROPERTY_DTZKASSOCIATEPB);
    }

    public void setDtzkAssociatepb(String dtzkAssociatepb) {
        set(PROPERTY_DTZKASSOCIATEPB, dtzkAssociatepb);
    }

    public Boolean isDtzkAssociatecostbudget() {
        return (Boolean) get(PROPERTY_DTZKASSOCIATECOSTBUDGET);
    }

    public void setDtzkAssociatecostbudget(Boolean dtzkAssociatecostbudget) {
        set(PROPERTY_DTZKASSOCIATECOSTBUDGET, dtzkAssociatecostbudget);
    }

    public String getDtzkFilename() {
        return (String) get(PROPERTY_DTZKFILENAME);
    }

    public void setDtzkFilename(String dtzkFilename) {
        set(PROPERTY_DTZKFILENAME, dtzkFilename);
    }

    public String getDtzkCostbudgetview() {
        return (String) get(PROPERTY_DTZKCOSTBUDGETVIEW);
    }

    public void setDtzkCostbudgetview(String dtzkCostbudgetview) {
        set(PROPERTY_DTZKCOSTBUDGETVIEW, dtzkCostbudgetview);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<EPBFirstlevelbudget> getEPBFirstlevelbudgetList() {
      return (List<EPBFirstlevelbudget>) get(PROPERTY_EPBFIRSTLEVELBUDGETLIST);
    }

    public void setEPBFirstlevelbudgetList(List<EPBFirstlevelbudget> ePBFirstlevelbudgetList) {
        set(PROPERTY_EPBFIRSTLEVELBUDGETLIST, ePBFirstlevelbudgetList);
    }

    @SuppressWarnings("unchecked")
    public List<EPBFourthlevelbgt> getEPBFourthlevelbgtList() {
      return (List<EPBFourthlevelbgt>) get(PROPERTY_EPBFOURTHLEVELBGTLIST);
    }

    public void setEPBFourthlevelbgtList(List<EPBFourthlevelbgt> ePBFourthlevelbgtList) {
        set(PROPERTY_EPBFOURTHLEVELBGTLIST, ePBFourthlevelbgtList);
    }

    @SuppressWarnings("unchecked")
    public List<EPBMainsection> getEPBMainsectionList() {
      return (List<EPBMainsection>) get(PROPERTY_EPBMAINSECTIONLIST);
    }

    public void setEPBMainsectionList(List<EPBMainsection> ePBMainsectionList) {
        set(PROPERTY_EPBMAINSECTIONLIST, ePBMainsectionList);
    }

    @SuppressWarnings("unchecked")
    public List<EPBSecondlevelbudget> getEPBSecondlevelbudgetList() {
      return (List<EPBSecondlevelbudget>) get(PROPERTY_EPBSECONDLEVELBUDGETLIST);
    }

    public void setEPBSecondlevelbudgetList(List<EPBSecondlevelbudget> ePBSecondlevelbudgetList) {
        set(PROPERTY_EPBSECONDLEVELBUDGETLIST, ePBSecondlevelbudgetList);
    }

    @SuppressWarnings("unchecked")
    public List<EPBThirdlevelbudget> getEPBThirdlevelbudgetList() {
      return (List<EPBThirdlevelbudget>) get(PROPERTY_EPBTHIRDLEVELBUDGETLIST);
    }

    public void setEPBThirdlevelbudgetList(List<EPBThirdlevelbudget> ePBThirdlevelbudgetList) {
        set(PROPERTY_EPBTHIRDLEVELBUDGETLIST, ePBThirdlevelbudgetList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Requisition> getProcurementRequisitionEMDTProjectIDList() {
      return (List<Requisition>) get(PROPERTY_PROCUREMENTREQUISITIONEMDTPROJECTIDLIST);
    }

    public void setProcurementRequisitionEMDTProjectIDList(List<Requisition> procurementRequisitionEMDTProjectIDList) {
        set(PROPERTY_PROCUREMENTREQUISITIONEMDTPROJECTIDLIST, procurementRequisitionEMDTProjectIDList);
    }

    @SuppressWarnings("unchecked")
    public List<Requisition> getProcurementRequisitionEMPcProjectIDList() {
      return (List<Requisition>) get(PROPERTY_PROCUREMENTREQUISITIONEMPCPROJECTIDLIST);
    }

    public void setProcurementRequisitionEMPcProjectIDList(List<Requisition> procurementRequisitionEMPcProjectIDList) {
        set(PROPERTY_PROCUREMENTREQUISITIONEMPCPROJECTIDLIST, procurementRequisitionEMPcProjectIDList);
    }
