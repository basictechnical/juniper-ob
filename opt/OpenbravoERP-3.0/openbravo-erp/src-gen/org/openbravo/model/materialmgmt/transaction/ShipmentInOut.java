...
public class ShipmentInOut extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_DTLORRYNO = "dtLorryno";
    public static final String PROPERTY_DTTRPNAME = "dtTrpname";
    public static final String PROPERTY_DTPOLINESFROMCOP = "dtpoLinesfromcop";
    ...
    public ShipmentInOut() {
        ...
        setDefaultValue(PROPERTY_DTPOLINESFROMCOP, false);
    ...
    public String getDtLorryno() {
        return (String) get(PROPERTY_DTLORRYNO);
    }

    public void setDtLorryno(String dtLorryno) {
        set(PROPERTY_DTLORRYNO, dtLorryno);
    }

    public String getDtTrpname() {
        return (String) get(PROPERTY_DTTRPNAME);
    }

    public void setDtTrpname(String dtTrpname) {
        set(PROPERTY_DTTRPNAME, dtTrpname);
    }

    public Boolean isDtpoLinesfromcop() {
        return (Boolean) get(PROPERTY_DTPOLINESFROMCOP);
    }

    public void setDtpoLinesfromcop(Boolean dtpoLinesfromcop) {
        set(PROPERTY_DTPOLINESFROMCOP, dtpoLinesfromcop);
    }
