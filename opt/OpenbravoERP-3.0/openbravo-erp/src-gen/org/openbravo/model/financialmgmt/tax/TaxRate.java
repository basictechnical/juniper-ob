...
public class TaxRate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ORDEREMDTPOCTAXIDLIST = "orderEMDtpoCTaxIDList";
    ...
    public TaxRate() {
        ...
        setDefaultValue(PROPERTY_ORDEREMDTPOCTAXIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Order> getOrderEMDtpoCTaxIDList() {
      return (List<Order>) get(PROPERTY_ORDEREMDTPOCTAXIDLIST);
    }

    public void setOrderEMDtpoCTaxIDList(List<Order> orderEMDtpoCTaxIDList) {
        set(PROPERTY_ORDEREMDTPOCTAXIDLIST, orderEMDtpoCTaxIDList);
    }
