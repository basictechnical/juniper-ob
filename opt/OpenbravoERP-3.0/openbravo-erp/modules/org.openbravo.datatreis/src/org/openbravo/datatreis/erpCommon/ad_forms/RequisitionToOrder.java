...
public class RequisitionToOrder extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strProjectId = vars.getGlobalVariable("inpcProjectId",
              "RequisitionToOrder|C_Project_ID", "");
      System.out.println("projectId is :"+strProjectId);
      ...
      printPageDataSheet(response, vars, strProductId, strDateFrom, strDateTo, strRequesterId,
          strVendorId, strIncludeVendor, strOrgId,strProjectId);
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strVendorId, String strIncludeVendor, String strOrgId,String strProjectId) throws IOException,
      ServletException {
	...
	RequisitionToOrderData[] datalines = RequisitionToOrderData.selectLines(this, vars
        ...
        : null), (strIncludeVendor.equals("Y") ? null : strVendorId),strProjectId);
    ...
    xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/datatreis/erpCommon/ad_forms/RequisitionToOrder",
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "org.openbravo.datatreis.erpCommon.ad_forms.RequisitionToOrder");
    ...
    //xmlDocument.setParameter("reportC_Project_ID", strProjectId);
    try {
        ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "C_Project_ID", "",
            "ProjectsWithRequisition", Utility.getContext(this, vars, "#AccessibleOrgTree",
  ...
  private void printPageCreate(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "org/openbravo/datatreis/erpCommon/ad_forms/RequisitionToOrderCreate").createXmlDocument();
    xmlDocument.setParameter("calendar", vars.getLanguage().substring(0, 2));
