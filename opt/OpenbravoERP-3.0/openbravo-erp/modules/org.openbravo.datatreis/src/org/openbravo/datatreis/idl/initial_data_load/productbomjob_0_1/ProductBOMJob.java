...
//
// ============================================================================
package org.openbravo.datatreis.idl.initial_data_load.productbomjob_0_1;
 ...
 * @status
 */
public class ProductBOMJob {

  private static Logger log4j = Logger.getLogger(ProductBOMJob.class);
  ...
  private final String jobName = "ProductBOMJob";
        ...
        try {
          for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
            if (m.getName().compareTo(currentComponent + "_error") == 0) {
              m.invoke(ProductBOMJob.this, new Object[] { e, globalMap });
              break;
            }
          }
  ...
  static class row60Struct implements routines.system.IPersistableRow<row60Struct> {
    ...
    public void copyDataTo(row60Struct other) {
      ...
      other.ParentProduct = this.ParentProduct;
      ...
      synchronized (commonByteArrayLock) {
        ...
        try {
          ...
          if (length == -1) {
            ...
            dis.readFully(commonByteArray, 0, length);
            this.ParentProduct = new String(commonByteArray, 0, length);
          }
          ...
          if (length == -1) {
            ...
            dis.readFully(commonByteArray, 0, length);
            this.Weight = new String(commonByteArray, 0, length);
          }
    ...
    public void writeData(ObjectOutputStream dos) {
      try {
        ...
        if (this.ParentProduct == null) {
          ...
          byte[] byteArray = this.ParentProduct.getBytes();
          dos.writeInt(byteArray.length);
          dos.write(byteArray);
        }
        ...
        if (this.Weight == null) {
          ...
          byte[] byteArray = this.Weight.getBytes();
          dos.writeInt(byteArray.length);
          dos.write(byteArray);
        }
    ...
    public String toString() {
      ...
      sb.append("=");
      sb.append(String.valueOf(this.ParentProduct));
      ...
      while (limittFileInputDelimited_1 != 0 && csvReadertFileInputDelimited_1.readRecord()) {
        ...
        try {
          ...
          if (rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])) {// empty
            ...
            if (4 < rowtFileInputDelimited_1.length) {
              row1.ParentProduct = rowtFileInputDelimited_1[4].trim();
            ...
            if (10 < rowtFileInputDelimited_1.length) {
              row1.Quantity = rowtFileInputDelimited_1[10].trim();
            ...
            if (14 < rowtFileInputDelimited_1.length) {
              row1.Weight = rowtFileInputDelimited_1[14].trim();
        ...
        if (row1 != null) {
          ...
          org.openbravo.idl.proc.IdlService service = org.openbravo.idl.proc.IdlIntService
              .getInstance().getService("ProductBOM");
          org.openbravo.idl.proc.Validator validator = service.getValidator("ProductBOM");
          ...
          row4.ParentProduct = validator.checkString(row1.ParentProduct, 60);
          ...
          row4.Quantity = validator.checkBigDecimal(row1.Quantity);
          row4.CostType = validator.checkString(row1.CostType, 32, "CostType");
          row4.AttributeSet = null;
          // validator.checkString(row1.AttributeSet, 60, "AttributeSet");
          row4.AttributeSetValue = null;
          // validator.checkString(row1.AttributeSetValue, 60,"AttributeSetValue");
          row4.Weight = validator.checkBigDecimal(row1.Weight);
          ...
          row4.TaxCategory = validator.checkNotNull(
              validator.checkString(row1.TaxCategory, 32, "TaxCategory"), "TaxCategory");
...

          {
            ...
            row2.ParentProduct = row4.ParentProduct;
            ...
            row6.ParentProduct = row4.ParentProduct;
          ...
          if (row2 != null) {
            ...
            row14.ParentProduct = row2.ParentProduct;
            ...
            row14.Quantity = row2.Quantity;
            row14.CostType = row2.CostType;
            // log4j.info("Cost Type : " + row2.CostType);
            /*
             * if (service.getReferenceValue("Cost Type", row2.CostType) == null && row2.CostType !=
             * null) { row14.flag = "-1"; row14.whyError +=
             * service.Utility_messageBD("IDL_BAD_REFERENCE") + row2.CostType + "\n"; }
             */
...

            {
              ...
              row60.ParentProduct = row14.ParentProduct;
              ...
              row21.ParentProduct = row14.ParentProduct;
            ...
            if (row60 != null) {
              ...
              currentComponent = "tJavaRow_16";
              // log4j.info("Insert records");
              service.finishRecordProcess(row60.Organization, row60.SearchKey, row60.Name,
                  row60.Description, row60.ParentProduct, row60.ProductCategory, row60.UOM,
                  row60.ProductType, row60.Production, row60.BillOfMaterial, row60.Quantity,
                  row60.CostType, row60.AttributeSet, row60.AttributeSetValue, row60.Weight,
            ...
            if (row21 != null) {
              ...
              service.logRecordError(row21.whyError, row21.Organization, row21.SearchKey,
                  row21.Name, row21.Description, row21.ParentProduct, row21.ProductCategory,
                  row21.UOM, row21.ProductType, row21.Production, row21.BillOfMaterial,
                  row21.Quantity, row21.CostType, row21.AttributeSet, row21.AttributeSetValue,
                  row21.Weight, row21.Purchase, row21.Sale, row21.TaxCategory, row21.StandardCost,
          ...
          if (row6 != null) {
            ...
            service.logRecordError(row6.whyError, row6.Organization, row6.SearchKey, row6.Name,
                row6.Description, row6.ParentProduct, row6.ProductCategory, row6.UOM,
                row6.ProductType, row6.Production, row6.BillOfMaterial, row6.Quantity,
                row6.CostType, row6.AttributeSet, row6.AttributeSetValue, row6.Weight,
                row6.Purchase, row6.Sale, row6.TaxCategory, row6.StandardCost, row6.Price_Sales,
                row6.Price_Purchase);
  ...
  public static void main(String[] args) {
    final ProductBOMJob ProductJobClass = new ProductBOMJob();
  ...
  public int runJobInTOS(String[] args) {
    ...
    try {
      java.io.InputStream inContext = ProductBOMJob.class.getClassLoader().getResourceAsStream(
          "initial_data_load/productbomjob_0_1/contexts/Default.properties");
      if (inContext != null) {
      ...
      if (contextStr.compareTo("Default") != 0) {
        inContext = ProductBOMJob.class.getClassLoader().getResourceAsStream(
            "initial_data_load/productbomjob_0_1/contexts/" + contextStr + ".properties");
        if (inContext != null) {
    ...
    if (false) {
      System.out.println((endUsedMemory - startUsedMemory)
          + " bytes memory increase when running : ProductBOMJob");
    }
