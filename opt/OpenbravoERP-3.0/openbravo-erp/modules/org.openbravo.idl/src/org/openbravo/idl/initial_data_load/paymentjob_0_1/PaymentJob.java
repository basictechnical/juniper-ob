...
public class PaymentJob {
	...
	private final String jobName = "PaymentJob";
	private final String projectName = "INITIAL_DATA_LOAD";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(PaymentJob.this, new Object[] { e,
									globalMap });
							break;
						}
					}
	...
	public void tFilterRow_1_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_3_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tFilterRow_2_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_5_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_4_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tJavaRow_2_error(Exception exception,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						this.Organization = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.BusinessPartner = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PaymentMethod = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PaymentDate = new String(commonByteArray, 0,
								length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.FinancialAccount = new String(commonByteArray, 0,
								length);
					}
		...
		try {
			...
			while (limittFileInputDelimited_1 != 0
				...
				try {
					...
					if (rowtFileInputDelimited_1.length == 1
						...
						if (1 < rowtFileInputDelimited_1.length) {
							row1.DocumentNo = rowtFileInputDelimited_1[1]
									.trim();
						...
						if (2 < rowtFileInputDelimited_1.length) {
							row1.BusinessPartner = rowtFileInputDelimited_1[2]
									.trim();
						...
						if (5 < rowtFileInputDelimited_1.length) {
							row1.PaymentMethod = rowtFileInputDelimited_1[5]
									.trim();
						...
						if (6 < rowtFileInputDelimited_1.length) {
							row1.PaymentDate = rowtFileInputDelimited_1[6]
									.trim();
						...
						if (7 < rowtFileInputDelimited_1.length) {
							row1.FinancialAccount = rowtFileInputDelimited_1[7]
									.trim();
						...
						if (11 < rowtFileInputDelimited_1.length) {
							row1.InvoiceNo = rowtFileInputDelimited_1[11]
									.trim();
				...
				if (row1 != null) {
					...
					org.openbravo.idl.proc.Validator validator = service
							.getValidator("Payable");

					row2.Organization = validator
							.checkOrganization(row1.Organization);
					row2.DocumentNo = validator
							.checkString(row1.DocumentNo, 30);
					row2.PaymentMethod = validator.checkString(
							row1.PaymentMethod, 60);
					row2.Currency = validator.checkString(row1.Currency, 3);
					row2.PaymentDate = validator.checkString(row1.PaymentDate,
							20);
					row2.IsReceipt = validator.checkBoolean(row1.IsReceipt,
							"IsReceipt");
					row2.BusinessPartner = validator.checkString(
							row1.BusinessPartner, 60);
					row2.FinancialAccount = validator.checkString(
							row1.FinancialAccount, 60);
					...
					row2.GLItem = validator.checkNotNull(validator.checkString(
							row1.GLItem, 60), "GLItem");
					row2.Amount = validator.checkString(row1.Amount, 10);
					...
					(row2.flag == null ? false : row2.flag.toLowerCase()
							.compareTo("0") == 0)
					...
					if (row4 != null) {
						...
						if (row4.Currency != null) {
							Currency cur = service.findDALInstance(false,
									Currency.class, new Value(
											Currency.PROPERTY_ISOCODE,
											row4.Currency));
							if (cur == null) {
								row6.flag = "-1";
								row6.whyError += service
										.Utility_messageBD("IDL_BAD_REFERENCE")
										+ row4.Currency + "\n";
							}
						}
						...
						if (row4.BusinessPartner != null) {
							BusinessPartner bp = service.findDALInstance(false,
									BusinessPartner.class, new Value(
											BusinessPartner.PROPERTY_SEARCHKEY,
						...
						if (row4.FinancialAccount != null) {
							FIN_FinancialAccount fa = service.findDALInstance(
									false, FIN_FinancialAccount.class,
									new Value(
						...
						if (row4.Project != null) {
							Project fa = service.findDALInstance(false,
									Project.class,
									new Value(Project.PROPERTY_NAME,
											row4.Project));
							if (fa == null) {
								row6.flag = "-1";
								row6.whyError += service
						...
						if (row4.Campaign != null) {
							Campaign camp = service.findDALInstance(false,
									Campaign.class, new Value(
						...
						if (row4.Activity != null) {
							ABCActivity act = service.findDALInstance(false,
									ABCActivity.class, new Value(
											ABCActivity.PROPERTY_NAME,
											row4.Activity));
							if (act == null) {
								row6.flag = "-1";
								row6.whyError += service
						...
						if (row4.GLItem != null) {
							GLItem gl = service.findDALInstance(false,
									GLItem.class, new Value(
						...
						(row6.flag == null ? false : row6.flag.toLowerCase()
								.compareTo("0") == 0)
						...
						if (row7 != null) {
							...
							service.finishRecordProcess(row7.Organization,
									row7.DocumentNo, row7.BusinessPartner,
									row7.IsReceipt, row7.Currency,
									row7.PaymentMethod, row7.PaymentDate,
									row7.FinancialAccount, row7.Project,
									row7.Campaign, row7.Activity,
									row7.InvoiceNo, row7.OrderNo, row7.GLItem,
									row7.Amount);
						...
						if (row5 != null) {
							...
							service.logRecordError(row5.whyError,
									row5.Organization, row5.DocumentNo,
									row5.BusinessPartner, row5.IsReceipt,
									row5.Currency, row5.PaymentMethod,
									row5.PaymentDate, row5.FinancialAccount,
									row5.Project, row5.Campaign, row5.Activity,
									row5.InvoiceNo, row5.OrderNo, row5.GLItem,
									row5.Amount);
					...
					if (row3 != null) {
						...
						service.logRecordError(row3.whyError,
								row3.Organization, row3.DocumentNo,
								row3.BusinessPartner, row3.IsReceipt,
								row3.Currency, row3.PaymentMethod,
								row3.PaymentDate, row3.FinancialAccount,
								row3.Project, row3.Campaign, row3.Activity,
								row3.InvoiceNo, row3.OrderNo, row3.GLItem,
								row3.Amount);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = PaymentJob.class
					.getClassLoader()
					.getResourceAsStream(
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = PaymentJob.class.getClassLoader()
						.getResourceAsStream(
								"initial_data_load/paymentjob_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : PaymentJob");
		}
...
/************************************************************************************************
 * 173123 characters generated by Talend Open Studio on the 27 de enero de 2012
 * 8:25:18 CET
 ************************************************************************************************/
