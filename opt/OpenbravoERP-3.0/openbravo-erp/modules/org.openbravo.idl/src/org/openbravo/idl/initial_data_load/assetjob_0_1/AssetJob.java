...
public class AssetJob {
  ...
  private final String jobName = "AssetJob";
    ...
    try {
      ...
      while (limittFileInputDelimited_1 != 0 && csvReadertFileInputDelimited_1.readRecord()) {
        ...
        if (row1 != null) {
          ...
          row2.Name = validator.checkNotNull(validator.checkString(row1.Name, 40), "Name");

          row2.Description = validator.checkString(row1.Description, 255);

          row2.ProductName = validator.checkString(row1.ProductName, 40);

          row2.AssetCategory = validator.checkNotNull(validator.checkString(row1.AssetCategory, 60,
              "AssetCategory"), "AssetCategory");

          row2.Quantity = validator.checkBigDecimal(row1.Quantity);

          row2.CalculateType = validator.checkNotNull(validator.checkString(row1.CalculateType, 60,
          ...
          row2.Currency = validator.checkNotNull(validator
              .checkString(row1.Currency, 3, "Currency"), "Currency");
  ...
  private int runJobInTOS(String[] args) {
    ...
    if (false) {
      System.out.println((endUsedMemory - startUsedMemory)
          + " bytes memory increase when running : AssetJob");
    }
